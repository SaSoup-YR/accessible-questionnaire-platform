import{r as pe,s as ge,a as p,i as Le,g as j,D as I,v as w,b as Me,c as Oe,d as qe,f as R,e as Ne,h as Ve,j as Ge,k as me,l as _e,P as Q,A as c,m as o,q as Be,n as W,o as K,p as Fe,t as De,u as Ue,w as He,x as fe,y as je,z as Qe}from"./shared-CpsLSs-5.js";const We="accessible-questionnaire:qualtrics-submit:v2",Ke="accessible-questionnaire:qualtrics-receipt:v2",Je="accessible-questionnaire:qualtrics-parent-ready:v2",Ye="accessible-questionnaire:qualtrics-child-ready:v2",Xe="accessible-questionnaire:qualtrics-advance-failed:v2",S="0.8.10-q10";function Ze(e=window){const t=e.accessibleQuestionnaireResultSink??e.accessibleNasaTlxResultSink;return!t||typeof t.name!="string"||!t.name.trim()||typeof t.submit!="function"?null:t}function et(e,t=window,i=()=>{},s=()=>{}){if(e.collection.mode!=="qualtrics")return null;const n=tt(e.collection.parentOrigin,t,i,s),a=it(e.collection.parentOrigin,t,12e3,()=>n.getState()==="connected");return t.accessibleQuestionnaireResultSink=a,t.accessibleNasaTlxResultSink=a,{sink:a,bridge:n}}function tt(e,t=window,i=()=>{},s=()=>{}){let n="connecting",a=null;const r=(h,m)=>{n==="connected"||n==="failed"&&h!=="connected"||(n=h,i({state:n,message:m}))},l=h=>{if(h.source!==t.parent||h.origin!==e)return;const m=h.data;if(m?.type===Xe){m.bridgeBuild===S&&typeof m.error=="string"&&m.error.trim()&&s(m.error);return}if(m?.type===Je){if(m.protocolVersion!==2||m.bridgeBuild!==S){r("failed",`This Qualtrics survey is using an old or incomplete bridge. Expected ${S}. Do not start this questionnaire.`);return}a!==null&&(t.clearTimeout(a),a=null),t.parent.postMessage({type:Ye,protocolVersion:2,bridgeBuild:S},e),r("connected",`Secure Qualtrics bridge ${S} connected.`)}};return t.addEventListener("message",l),i({state:n,message:`Checking Qualtrics bridge ${S}.`}),a=t.setTimeout(()=>{a=null,n!=="connected"&&r("failed",`The required Qualtrics bridge ${S} did not connect. Do not start this questionnaire.`)},8500),{getState:()=>n,disconnect(){a!==null&&(t.clearTimeout(a),a=null),t.removeEventListener("message",l)}}}function it(e,t=window,i=12e3,s=()=>!0){return{name:"UCL Qualtrics",submit(n){return t.parent===t?Promise.reject(new Error("This centrally collected questionnaire must be opened through its Qualtrics survey.")):s()?new Promise((a,r)=>{let l=!1;const h=y=>{l||(l=!0,t.clearTimeout(b),t.removeEventListener("message",m),y())},m=y=>{if(y.source!==t.parent||y.origin!==e)return;const g=y.data;if(!(!g||g.type!==Ke||g.submissionId!==n.submissionId||g.bridgeBuild!==S)){if(g.accepted!==!0){h(()=>r(new Error(typeof g.error=="string"&&g.error?g.error:"Qualtrics did not accept the response.")));return}h(()=>a({accepted:!0,submissionId:n.submissionId,receiptId:typeof g.receiptId=="string"?g.receiptId:void 0}))}},b=t.setTimeout(()=>{h(()=>r(new Error("Qualtrics did not acknowledge the response in time.")))},i);t.addEventListener("message",m),t.parent.postMessage({type:We,bridgeBuild:S,record:n},e)}):Promise.reject(new Error(`Qualtrics bridge ${S} is not connected. The response remains in the local backup.`))}}}async function st(e,t,i=15e3){let s;const n=new Promise((r,l)=>{s=setTimeout(()=>l(new Error("The study platform did not acknowledge the staged response in time.")),i)});let a;try{a=await Promise.race([t.submit(e),n])}finally{s!==void 0&&clearTimeout(s)}if(!a||a.accepted!==!0||a.submissionId!==e.submissionId||a.receiptId!==void 0&&typeof a.receiptId!="string")throw new Error("The study platform returned an invalid submission receipt.");return a}const F=new Map([["zero",0],["five",5],["one zero",10],["ten",10],["fifteen",15],["twenty",20],["twenty five",25],["thirty",30],["thirty five",35],["forty",40],["forty five",45],["fifty",50],["fifty five",55],["sixty",60],["sixty five",65],["seventy",70],["seventy five",75],["eighty",80],["eighty five",85],["ninety",90],["ninety five",95],["one zero zero",100],["one hundred",100],["hundred",100]]),q=new Map([["zero","0"],["oh","0"],["one","1"],["two","2"],["three","3"],["four","4"],["five","5"],["six","6"],["seven","7"],["eight","8"],["nine","9"]]),z=new Map([["won",1],["to",2],["too",2],["tree",3],["free",3],["for",4],["fore",4],["fife",5],["ate",8]]),J=["zero","one","two","three","four","five","six","seven","eight","nine","ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen"],Y=["","","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety"];function be(e){if(e<20)return J[e];if(e===100)return"one hundred";const t=Math.floor(e/10),i=e%10;return i===0?Y[t]:`${Y[t]} ${J[i]}`}for(let e=0;e<=100;e+=1){F.set(be(e),e);const t=String(e).split("").map(i=>[...q].find(([,s])=>s===i)?.[0]).filter(i=>!!i).join(" ");t&&F.set(t,e)}const D=new Set([...q.keys(),"ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","hundred"]),U=/\b(?:not|note|knot|naught|nought|no|nope|nah|never|cannot|cancel|neither|except|without|minus|negative|skip|avoid|exclude|reject|instead|rather|unsure|uncertain|maybe|perhaps|mistake|wrong)\b|\b(?:(?:anything|everything)\s+but|other\s+than|don\s+t|can\s+t|won\s+t|wouldn\s+t|shouldn\s+t|isn\s+t|wasn\s+t)\b/,ye={mental:["mental demand","mental"],physical:["physical demand","physical"],temporal:["temporal demand","temporal","time pressure"],performance:["performance"],effort:["effort"],frustration:["frustration"]};function T(e){return e.toLowerCase().replace(/[-–—]/g," ").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function nt(e,t,i,s=!0){const n=[],a=[];for(const r of t){const l=Number.isInteger(r)&&r>=0&&r<=100?be(r):String(r);if(n.push(String(r),l,`number ${l}`,`not ${l}`),a.push(`option ${l}`,`rating ${l}`,`value ${l}`,`answer ${l}`,`choice ${l}`),s){const h=e.responseLabels?.[String(r)];h?.trim()&&(n.push(h.trim()),a.push(`answer ${h.trim()}`,`choose ${h.trim()}`))}}return s&&(n.push(e.lowAnchor,e.highAnchor,...e.voiceLowAliases??[],...e.voiceHighAliases??[]),i.length===5&&n.push("middle","midpoint",`closer to ${e.lowAnchor}`,`closer to ${e.highAnchor}`)),[...new Set([...n,...a].map(r=>r.trim()).filter(Boolean))]}function at(e){return[...new Set(e.flatMap(t=>typeof t!="string"?[t.name,t.id.replace(/[-_]/g," ")]:ye[t]??[t.replace(/[-_]/g," ")]).map(t=>t.trim()).filter(Boolean))]}function ve(e){return U.test(T(e))}function we(e,t){const i=e.map(a=>a.trim()).filter(Boolean);if(i.length===0)return null;const s=i.map((a,r)=>({transcript:a,value:t(a),index:r}));if(s.some(({transcript:a,value:r})=>r===null&&ve(a)))return null;const n=s.filter(a=>a.value!==null);return n.length===0?null:{transcript:n[0].transcript,value:n[0].value}}function X(e,t){return new Set([e,...t??[]].map(T).filter(Boolean))}function H(e){return e.replace(/^(?:(?:i\s+)?(?:choose|select|pick)|(?:my\s+)?answer(?:\s+is)?|(?:the\s+)?(?:number|option|rating|value|response|choice)(?:\s+is)?)\s+/,"").trim()}function Z(e){return e.replace(/\bdis\s+a\s+gr(?:ay|ey)\b/g,"disagree").replace(/\ba\s+gr(?:ay|ey)\b/g,"agree").replace(/\bstrong\s+lee\b/g,"strongly").replace(/\bdisagreed\b/g,"disagree").replace(/\bagreed\b/g,"agree").replace(/^neither\s+(.+)\s+or\s+(.+)$/,"neither $1 nor $2")}function rt(e,t,i){const s=H(e),n=X(t.lowAnchor,t.voiceLowAliases).has(s),a=X(t.highAnchor,t.voiceHighAliases).has(s);if(!(!n&&!a))return n&&a?null:n?i[0]:i.at(-1)??null}function ot(e,t,i){if(!t.responseLabels)return;const s=Z(H(e)),n=i.filter(a=>Z(T(t.responseLabels?.[String(a)]??""))===s);if(n.length!==0)return n.length===1?n[0]:null}function lt(e,t){const i=H(e),s=i.split(" ").filter(Boolean);if(s.length===0||!s.every(r=>/^(?:100|[0-9]{1,2})$/.test(r)||D.has(r)||z.has(r)))return;const a=Se(i,t,!0);return a.length!==1||a[0]===null?null:a[0]}function Se(e,t,i=!1){const s=e.split(" ").filter(Boolean),n=[];for(const a of s)if(/^(?:100|[0-9]{1,2})$/.test(a)){const r=Number(a);n.push(t.includes(r)?r:null)}for(let a=0;a<s.length;){if(!D.has(s[a])&&!(i&&z.has(s[a]))){a+=1;continue}const r=[];for(;a<s.length&&(D.has(s[a])||i&&z.has(s[a]));)r.push(s[a]),a+=1;const l=r.length===1&&q.has(r[0])?Number(q.get(r[0])):r.length===1&&z.has(r[0])?z.get(r[0]):F.get(r.join(" "));n.push(l!==void 0&&t.includes(l)?l:null)}return n}function ee(e){return e?.map(t=>t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|")}function x(e,t){return e.find(i=>i.position===t)?.value}function dt(e,t,i){const s=/\b(middle|midpoint|centre|center)\b/.test(e),n=ee(t.voiceLowAliases),a=ee(t.voiceHighAliases);if(!n||!a||i.length!==5)return;const r=`(?:${n})`,l=`(?:${a})`,h=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${r}\\b`).test(e),m=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${l}\\b`).test(e),b=t.voiceLowAliases?.includes("low")===!0&&e==="hello",y=new RegExp(`\\b${r}\\b`).test(e)||b,g=new RegExp(`\\b${l}\\b`).test(e);if(h||m)return[s,h,m].filter(Boolean).length!==1||h&&g||m&&y?null:h?x(i,"closer-low")??null:x(i,"closer-high")??null;if([s,y,g].some(Boolean))return[s,y,g].filter(Boolean).length!==1?null:s?x(i,"middle")??null:y?x(i,"low")??null:x(i,"high")??null}function ct(e,t,i=pe,s=ge){const n=T(e);if(!n)return null;const a=ot(n,t,i);if(a!==void 0)return a;const r=rt(n,t,i);if(r!==void 0)return r;if(U.test(n))return null;const l=dt(n,t,s),h=lt(n,i);if(h!==void 0)return h===null||l===null||l!==void 0&&l!==h?null:h;if(l===null)return null;if(l!==void 0){const m=Se(n,i);return m.length===0?l:m.length!==1||m[0]===null||m[0]!==l?null:l}return null}function ut(e,t){const i=T(e);if(!i||U.test(i))return null;const s=t.map(n=>{const a=typeof n=="string"?n:n.id;return(typeof n=="string"?ye[a]??[a.replace(/[-_]/g," ")]:[n.name.toLowerCase(),a.replace(/[-_]/g," ")]).some(l=>i===l||i.includes(l))?a:null}).filter(n=>!!n);return s.length===1?s[0]:null}function ht(e,t,i=pe,s=ge){return we(e,n=>ct(n,t,i,s))}function pt(e,t){return we(e,i=>ut(i,t))}const N="3.5.3",gt=`https://cdn.jsdelivr.net/npm/webgazer@${N}/dist/webgazer.js`,mt=`https://cdn.jsdelivr.net/npm/webgazer@${N}/dist/mediapipe/face_mesh`,ft="sha384-N9TfYQEjUGiaDcITkzB/MtVHEfF2JtTWCwHG8NUhjOSvJ8zObGwfebHUFLBS+4Rb";let k=null;function te(e){return e.protocol==="https:"||e.hostname==="localhost"||e.hostname==="127.0.0.1"}function bt(e=document){return window.webgazer?Promise.resolve(window.webgazer):k||(k=new Promise((t,i)=>{const s=e.querySelector("#webgazer-loader"),n=s??e.createElement("script"),a=()=>{window.webgazer?t(window.webgazer):i(new Error("WebGazer loaded without exposing its browser API."))};n.addEventListener("load",a,{once:!0}),n.addEventListener("error",()=>{n.remove(),i(new Error("WebGazer could not be downloaded. Check the connection and content-blocking settings."))},{once:!0}),s||(n.id="webgazer-loader",n.src=gt,n.integrity=ft,n.crossOrigin="anonymous",n.referrerPolicy="no-referrer",e.head.append(n))}).catch(t=>{throw k=null,t}),k)}class ie{constructor(t){this.durationMs=t,this.key=null,this.startedAt=0}update(t,i){if(!t)return this.reset(),{progress:0,activated:!1};if(t!==this.key)return this.key=t,this.startedAt=i,{progress:0,activated:!1};const s=Math.min(1,Math.max(0,(i-this.startedAt)/this.durationMs));return s>=1?(this.reset(),{progress:1,activated:!0}):{progress:s,activated:!1}}reset(){this.key=null,this.startedAt=0}}var yt=Object.defineProperty,vt=Object.getOwnPropertyDescriptor,u=(e,t,i,s)=>{for(var n=s>1?void 0:s?vt(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(n=(s?r(t,i,n):r(n))||n);return s&&n&&yt(t,i,n),n};function V(e){return e.trim().toLocaleLowerCase().split("-")[0]==="en"}const L=[{x:12,y:12},{x:50,y:12},{x:88,y:12},{x:12,y:50},{x:50,y:50},{x:88,y:50},{x:12,y:88},{x:50,y:88},{x:88,y:88}],A=3;function G(e){const t=me(e);for(let i=t.length-1;i>0;i-=1){const s=Math.floor(Math.random()*(i+1));[t[i],t[s]]=[t[s],t[i]]}return t}let d=class extends Le{constructor(){super(...arguments),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=G(j(I)),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.answerMode="standard",this.showSimpleLanguage=!1,this.largeText=!1,this.recoveryEnabled=!1,this.resumeSummaryVisible=!1,this.savedSession=null,this.savedSessionProblem="",this.recoveredCompletedRecord=null,this.readingAloud=!1,this.readAloudUsed=!1,this.audioGuidance=!1,this.audioStatusMessage="",this.interruptionSummaryShown=!1,this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.errorMessage="",this.statusMessage="",this.result=null,this.gazeState="off",this.gazeMessage="",this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeUsed=!1,this.gazeActionCount=0,this.studyConfig=null,this.configurationError="",this.participantCode="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.startedAt="",this.submittedRecord=null,this.completionSavedLocally=!1,this.completionStagedByBridge=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.browserStorageFailed=!1,this.submittingResult=!1,this.hostBridgeState="not-required",this.hostBridgeMessage="",this.hiddenAt=null,this.recognition=null,this.webgazer=null,this.gazeCandidateElement=null,this.gazePendingElement=null,this.gazeActivationInProgress=!1,this.speechRequestId=0,this.savedSessionAnnouncementKey="",this.configurationApplied=!1,this.prefilledParticipantCode="",this.invalidParticipantParameter=!1,this.reviewReturnFocusIndex=null,this.installedResultSink=null,this.gazeCandidateTracker=new ie(1e3),this.gazeConfirmationTracker=new ie(1200),this.repeatSavedSessionOffer=()=>{this.savedSession&&(this.readAloudUsed=!0,this.speakText(this.savedSessionOfferSpeech(this.savedSession)))},this.setParticipantCode=e=>{this.participantCode=e.currentTarget.value.trim(),this.invalidParticipantParameter=!1,this.participantCodeRestoredForTab=!1,this.participantCodeError=this.participantCode&&!w(this.participantCode)?"Use 1–32 letters, numbers, hyphens or underscores, starting with a letter or number.":"",this.savedSession=null,this.savedSessionProblem="",this.recoveredCompletedRecord=null,w(this.participantCode)?(this.rememberParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup()):this.forgetParticipantCodeForTab()},this.setAudioGuidance=e=>{const t=e.currentTarget.checked;this.recordSupportChange("automatic-audio",this.audioGuidance,t),this.audioGuidance=t,this.invalidatePendingSubmission(),this.audioGuidance?this.speakText("Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open."):this.stopReading(),this.persistProgress()},this.startQuestionnaire=()=>{if(this.configurationError){this.showError(this.configurationError);return}if(this.studyConfig?.collection.mode==="qualtrics"&&this.hostBridgeState!=="connected"){this.showError(this.hostBridgeMessage||"The secure Qualtrics result connection is not ready. Do not start this questionnaire.");return}if(this.studyConfig){if(this.participantCode=this.participantCode.trim(),!w(this.participantCode)){this.participantCodeError="Enter the valid pseudonymous participant code supplied by the study conductor.",this.showError(this.participantCodeError);return}this.rememberParticipantCodeForTab()}this.startedAt=new Date().toISOString(),this.stage="ratings",this.ratingIndex=0,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.clearError(),this.persistProgress(),this.focusHeading()},this.goBack=()=>{if(this.stopReading(),this.clearVoiceAnswer(),this.stage==="ratings"&&this.editingRatingFromReview){const e=this.reviewReturnFocusIndex??this.ratingIndex;this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.stage="review",this.clearError(),this.persistProgress(),this.focusReviewItem(e,`${this.dimensions[e].name} edit cancelled. Original answer kept.`);return}else this.stage==="ratings"&&this.ratingIndex>0?this.ratingIndex-=1:this.stage==="pairs"&&(this.pairIndex>0?this.pairIndex-=1:(this.stage="ratings",this.ratingIndex=this.dimensions.length-1));this.clearError(),this.persistProgress(),this.focusHeading()},this.returnToRatings=()=>{this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.stage="ratings",this.ratingIndex=this.dimensions.length-1,this.persistProgress(),this.focusHeading()},this.returnToPairs=()=>{this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.stage="pairs",this.pairIndex=this.pairOrder.length-1,this.persistProgress(),this.focusHeading()},this.submitResponses=async()=>{if(!this.submittingResult)try{(!this.result||!this.submittedRecord)&&(this.result=Me(this.definition,this.ratings,this.pairResponses),this.submittedRecord=Oe({config:this.effectiveStudyConfig(),participantCode:this.studyConfig?this.participantCode:"DEMO",startedAt:this.startedAt||new Date().toISOString(),pairPresentationOrder:this.pairOrder.map(({id:t})=>t),pairwiseChoices:this.pairResponses,result:this.result,supportMetadata:this.currentSupportMetadata()}));const e=this.studyConfig?Ze():null;if(this.completionSavedLocally=this.studyConfig?qe(this.submittedRecord):!1,this.completionStagedByBridge=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.browserStorageFailed=!1,this.studyConfig&&!this.completionSavedLocally){this.browserStorageFailed=!0,this.showError("The browser could not save the completed record. The study platform has not been contacted. Your answers remain reviewable. Retry saving, change an answer, or download a JSON or CSV backup before leaving this page.");return}if(e){this.submittingResult=!0,this.statusMessage=`Submitting responses to ${e.name}.`;try{await st(this.submittedRecord,e),this.completionStagedByBridge=!0}catch(t){this.hostSubmissionFailed=!0,this.browserStorageFailed=!1;const i=t instanceof Error?t.message:"The study platform did not accept the response.";this.showError(`${i} Your answers remain on this page. Retry submission, return to an answer, or use a backup button below.`);return}finally{this.submittingResult=!1}}this.dispatchEvent(new CustomEvent("questionnaire-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("nasa-tlx-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.stage="complete",(!this.studyConfig||this.completionSavedLocally)&&this.clearSavedProgress(),this.stopGazeInputInternal(!1),this.clearError(),this.completionStagedByBridge||this.focusHeading()}catch(e){this.submittingResult=!1,this.showError(e instanceof Error?e.message:"Responses could not be calculated.")}},this.downloadResultJson=()=>{this.submittedRecord&&this.downloadRecordJson(this.submittedRecord)},this.downloadResultCsv=()=>{this.submittedRecord&&this.downloadRecordCsv(this.submittedRecord)},this.restart=()=>{this.stopReading(!1),this.stopGazeInputInternal(!1),this.releaseRecognition(),this.clearSavedProgress(),this.forgetParticipantCodeForTab(),this.stage="intro",this.ratingIndex=0,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.pairIndex=0,this.pairOrder=G(this.definition),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionStagedByBridge=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.browserStorageFailed=!1,this.submittingResult=!1,this.startedAt="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.studyConfig&&(this.participantCode=this.prefilledParticipantCode),this.errorMessage="",this.voiceState="idle",this.pendingVoiceAnswer=null,this.audioGuidance=!1,this.audioStatusMessage="",this.gazeUsed=!1,this.gazeActionCount=0,this.applyConfiguredSupport(),this.statusMessage="A new questionnaire has started.",window.scrollTo({top:0,behavior:"smooth"})},this.toggleReadAloud=()=>{if(this.readingAloud){this.stopReading(!0);return}this.speakText(this.currentStepSpeech())},this.startGazeInput=async()=>{if(!te(window.location)){this.gazeState="error",this.gazeMessage="Gaze input requires an HTTPS-hosted page or localhost.",this.announceAutomatic(this.gazeMessage);return}this.gazeState="loading",this.gazeMessage="Loading the pinned WebGazer library. Webcam permission will be requested next.";try{const e=await bt();if(!e.detectCompatibility())throw new Error("This browser does not expose a compatible webcam API.");this.webgazer=e,e.params.faceMeshSolutionPath=mt,e.saveDataAcrossSessions(!1),await e.clearData(),e.showVideoPreview(!0),e.showFaceOverlay(!0),e.showFaceFeedbackBox(!0),e.showPredictionPoints(!1),e.setGazeListener(t=>this.handleGazePoint(t)),await e.begin(),e.removeMouseEventListeners(),await this.showGazePositioningStep("Camera started. Position your face, then continue to calibration.")}catch(e){this.gazeState="error",this.gazeMessage=e instanceof Error?`Gaze setup did not start: ${e.message}`:"Gaze setup did not start. Use another answer route.",this.announceAutomatic(this.gazeMessage),this.releaseGazeResources()}},this.restartGazeCalibration=async()=>{this.webgazer&&(this.cancelGazeProposal(),await this.webgazer.clearData(),await this.showGazePositioningStep("Recalibration started. Check your position before continuing."))},this.beginGazeCalibration=()=>{this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!1),this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazeState="calibrating",this.gazeMessage="Camera preview hidden. Complete all 27 calibration samples.",this.announceAutomatic(this.gazeMessage),this.updateComplete.then(()=>this.querySelector(".calibration-point")?.focus()))},this.recordCalibrationPoint=e=>{if(!this.webgazer||this.gazeState!=="calibrating")return;const t=e.currentTarget.getBoundingClientRect();if(this.webgazer.recordScreenPosition(t.left+t.width/2,t.top+t.height/2,"click"),this.gazeCalibrationRepetition<A-1){this.gazeCalibrationRepetition+=1;return}if(this.gazeCalibrationIndex<L.length-1){this.gazeCalibrationIndex+=1,this.gazeCalibrationRepetition=0;return}this.gazeCalibrationRepetition=A,this.gazeState="ready",this.gazeUsed=!0,this.gazeMessage="Calibration complete. A red gaze dot is visible. Look at a large answer or navigation control for one second.",this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!0),this.statusMessage="Gaze-assisted answering is ready.",this.announceAutomatic(this.statusMessage)},this.confirmGazeProposal=()=>{const e=this.gazePendingElement;if(!e)return;const t=this.gazePendingLabel;this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.gazeActivationInProgress=!0;try{e.click(),this.gazeActionCount+=1,this.gazeUsed=!0,this.statusMessage=`${t} activated by confirmed gaze.`}finally{this.gazeActivationInProgress=!1}},this.cancelGazeProposal=()=>{this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.statusMessage="Gaze proposal cancelled."},this.stopGazeInput=()=>{this.stopGazeInputInternal(!0)},this.confirmVoiceAnswer=()=>{const e=this.pendingVoiceAnswer;if(!e)return;let t="";if(e.context==="rating"){const i=this.dimensions[this.ratingIndex],s=e.value;this.selectRating(i.id,s,"voice"),t=this.answerMode==="smiley"&&this.smileyLandmarks.some(a=>a.value===s)?`smiley-${i.id}-${s}`:`rating-${i.id}-${s}`}else{const i=this.pairOrder[this.pairIndex],s=e.value;this.selectPair(i.id,s,"voice"),t=`${i.id}-${s}`}this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.updateComplete.then(()=>this.querySelector(`#${t}`)?.focus())},this.clearVoiceAnswer=()=>{this.releaseRecognition(),this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null},this.handleVisibilityChange=()=>{if(document.hidden){this.hiddenAt=Date.now();return}this.hiddenAt&&this.recoveryEnabled&&this.isInProgress()&&(this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.statusMessage="Welcome back. A summary of your saved position is available.",this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())})),this.hiddenAt=null},this.handleParticipantStudyHashChange=()=>{new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash).has("study")&&this.reloadForParticipantStudyLink()},this.handleSkipToCurrentQuestion=e=>{e.preventDefault(),this.updateComplete.then(()=>{const t=this.querySelector("#question-panel");if(!t)return;const i=t.querySelector("h2")??t;i.hasAttribute("tabindex")||(i.tabIndex=-1),R(i,{block:"start",onReveal:()=>this.requestParentReveal(i)})})},this.dismissResumeSummary=()=>{this.resumeSummaryVisible=!1,this.statusMessage=`Continuing at ${this.currentPositionDescription()}.`,this.focusHeading()},this.restoreSavedSession=()=>{const e=this.savedSession;e&&(this.stage=e.stage,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.ratingIndex=e.ratingIndex,this.pairIndex=e.pairIndex,this.pairOrder=e.pairOrder,this.pairResponses=e.pairResponses,this.ratings=e.ratings,this.ratingInputRoutes=e.ratingInputRoutes,this.pairInputRoutes=e.pairInputRoutes,this.supportChanges=e.supportChanges,this.startedAt=e.startedAt,this.canAdjustAllSupport?(this.answerMode=e.support.answerMode,this.showSimpleLanguage=e.support.showSimpleLanguage,this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance):(this.applyConfiguredSupport(),this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)),this.recoveryEnabled=!0,this.savedSession=null,this.savedSessionProblem="",this.savedSessionAnnouncementKey="",this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())}))},this.eraseSavedSession=()=>{this.clearSavedProgress(),this.savedSession=null,this.savedSessionProblem="",this.savedSessionAnnouncementKey="",this.statusMessage="Saved answers erased."}}connectedCallback(){super.connectedCallback(),this.loadStudyConfiguration(),document.addEventListener("visibilitychange",this.handleVisibilityChange),window.addEventListener("hashchange",this.handleParticipantStudyHashChange),queueMicrotask(()=>{this.restoreParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup(),this.participantCodeRestoredForTab&&!this.savedSession&&this.recoveredCompletedRecord&&this.updateComplete.then(()=>{const e=this.querySelector("#completed-backup-heading");e&&R(e,{block:"start",onReveal:()=>this.requestParentReveal(e)})})})}disconnectedCallback(){document.removeEventListener("visibilitychange",this.handleVisibilityChange),window.removeEventListener("hashchange",this.handleParticipantStudyHashChange),this.installedResultSink?.bridge.disconnect(),this.installedResultSink=null,this.stopReading(!1),this.releaseRecognition(),this.stopGazeInputInternal(!1),super.disconnectedCallback()}createRenderRoot(){return this}loadStudyConfiguration(){if(this.configurationApplied)return;this.configurationApplied=!0;const e=new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash),t=Ne(window.location.hash);if(e.has("study")&&!t){this.configurationError="This participant link contains an invalid or incompatible study configuration. Ask the study conductor for a new link.";return}if(!t)return;this.studyConfig=t;const i=e.get("participant"),s=Ve(window.location.hash);if(s?(this.prefilledParticipantCode=s,this.participantCode=s):i&&(this.invalidParticipantParameter=!0,this.participantCodeError="The participant code in this link is invalid. Enter the approved pseudonymous code manually or ask the study conductor for a new link."),this.pairOrder=G(this.definition),this.applyConfiguredSupport(),t.collection.mode==="qualtrics"){if(window.parent===window){this.configurationError="This centrally collected questionnaire must be opened from the approved Qualtrics survey link. Ask the study conductor for that link.";return}if(document.referrer)try{if(new URL(document.referrer).origin!==t.collection.parentOrigin){this.configurationError="This questionnaire was embedded by an unexpected website. Ask the study conductor for the approved Qualtrics survey link.";return}}catch{this.configurationError="The embedding website could not be verified. Ask the study conductor for the approved Qualtrics survey link.";return}this.hostBridgeState="connecting",this.installedResultSink=et(t,window,({state:n,message:a})=>{this.hostBridgeState=n,this.hostBridgeMessage=a},n=>{this.remoteRecordingUnconfirmed=!0,this.statusMessage=n,this.announceAutomatic(this.currentStepSpeech()),this.updateComplete.then(()=>{const a=this.querySelector("#remote-recording-error");a&&R(a,{block:"start",onReveal:()=>this.requestParentReveal(a)})})})}}applyConfiguredSupport(){const e=this.studyConfig?.support;e&&(this.showSimpleLanguage=e.showSimpleLanguage,this.answerMode=e.answerMode,this.largeText=e.largeText,this.audioGuidance=e.audioGuidance,this.recoveryEnabled=e.recoveryEnabled)}get definition(){const e=this.studyConfig?.instrumentId??I;return Ge(e,this.studyConfig?.questionnaireDefinition)}get dimensions(){return this.definition.items}get pairs(){return me(this.definition)}get ratingValues(){return _e(this.definition)}get smileyLandmarks(){return this.definition.landmarks??[]}get isResearcherSuppliedDefinition(){return!!this.studyConfig?.questionnaireDefinition}get dimensionById(){return new Map(this.dimensions.map(e=>[e.id,e]))}get canAdjustAllSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get canAdjustPresentationSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="presentation-only"||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get voiceInputAvailable(){return!this.studyConfig||this.studyConfig.support.voiceInputAvailable}get gazeInputAvailable(){return!this.studyConfig||this.studyConfig.support.gazeInputAvailable}render(){return o`
      ...
      <main class=${`app-shell${this.largeText?" large-text":""}`} id="main-content">
        ...
        <header class="app-header">
          <p class="eyebrow">Accessible questionnaire platform · Version ${Q}</p>
    ...
    `}renderGazeSetup(){if(!this.gazeInputAvailable)return c;const e=te(window.location),t=this.gazeState==="loading"||this.gazeState==="positioning"||this.gazeState==="calibrating"||this.gazeState==="ready";return o`
      <details class="gaze-setup" .open=${this.gazeState!=="off"}>
        ...
        <div class="gaze-setup-content">
          ...
          <ul>
            ...
            <li>WebGazer ${N} is loaded only after you start this feature; its code and face model come from jsDelivr.</li>
    ...
    `},e.releaseRecognition=function(n=this.recognition){oe(this),i.call(this,n)},e.startVoiceInput=function(n,a,r,l=!0){E(),oe(this),t.call(this,n,a,r,l);const h=this.recognition;if(!h||this.voiceState!=="listening")return;At(this,h);const m=h.onerror;h.onerror=b=>{if(this.recognition===h){if(this.voiceState==="listening"&&(b.error==="no-speech"||b.error==="aborted")){this.releaseRecognition(h),_(this,re);return}m?.(b)}},h.onend=()=>{this.recognition===h&&this.voiceState==="listening"&&(this.releaseRecognition(h),_(this,re))},this.__rf06VoiceWatchdogTimerId=window.setTimeout(()=>{this.__rf06VoiceWatchdogTimerId=null,!(this.recognition!==h||this.voiceState!=="listening")&&(this.releaseRecognition(h),_(this,It))},Ct)}}kt();const zt=typeof globalThis.Element<"u"&&typeof globalThis.Document<"u",B=globalThis.__bypassNativeAriaNotify===!0;if(zt&&(B||!("ariaNotify"in Element.prototype)||!("ariaNotify"in Document.prototype))){let e=function(g){return new Promise(f=>setTimeout(f,g))},t=`${Date.now()}`;try{t=crypto.randomUUID()}catch{}const i=Symbol(),s=`polite-live-region-${t}`,n=`assertive-live-region-${t}`;class a{constructor({element:f,message:v,priority:C="normal"}){this.priority="normal",this.element=f,this.message=v,this.priority=C}#e(){const f=typeof globalThis.CSS<"u"&&typeof globalThis.CSS.supports=="function"&&globalThis.CSS.supports("selector(:modal)"),v=this.element.ownerDocument.querySelector(f?":modal":"dialog[open]");return this.element.isConnected&&!this.element.closest("[inert]")&&(v?.contains(this.element)??!0)}async announce(){if(!this.#e())return;let f=this.element.closest("dialog")||this.element.closest("[role='dialog']")||this.element.getRootNode();(!f||f instanceof Document)&&(f=document.body);const v=this.priority==="high"?n:s;let C=f.querySelector(v);C||(C=document.createElement(v),f.append(C)),await e(250),C.handleMessage(i,this.message)}}const r=new class{#e=[];#t;enqueue(f){if(f.priority==="high"){const v=this.#e.findLastIndex(C=>C.priority==="high");this.#e.splice(v+1,0,f)}else this.#e.push(f);this.#t||this.#i()}async#i(){this.#t=this.#e.shift(),this.#t&&(await this.#t.announce(),this.#t=null,this.#i())}};class l extends HTMLElement{#e=this.attachShadow({mode:"closed"});connectedCallback(){this.ariaAtomic="true",this.style.marginLeft="-1px",this.style.marginTop="-1px",this.style.position="absolute",this.style.width="1px",this.style.height="1px",this.style.overflow="hidden",this.style.clipPath="rect(0 0 0 0)",this.style.overflowWrap="normal"}handleMessage(f=null,v=""){i===f&&(this.#e.textContent===v&&(v+=" "),this.#e.textContent=v)}}class h extends l{connectedCallback(){this.ariaLive="polite",super.connectedCallback()}}class m extends l{connectedCallback(){this.ariaLive="assertive",super.connectedCallback()}}customElements.define(s,h),customElements.define(n,m);const b=function(g,{priority:f="normal"}={}){r.enqueue(new a({element:this,message:g,priority:f}))};(B||!("ariaNotify"in Element.prototype))&&Object.defineProperty(Element.prototype,"ariaNotify",{configurable:!0,writable:!0,value:b});const y=function(g,{priority:f="normal"}={}){r.enqueue(new a({element:this.documentElement,message:g,priority:f}))};(B||!("ariaNotify"in Document.prototype))&&Object.defineProperty(Document.prototype,"ariaNotify",{configurable:!0,writable:!0,value:y})}const Pt=400,Et="Large text selected.",Tt="Standard text selected.",Lt="Interruption recovery is on. Incomplete answers will be stored in this browser.",Mt="Interruption recovery is off. The saved in-progress copy has been removed.",Ce="Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open.",Re="Built-in audio guidance is off. New questions and feedback will not be spoken automatically.";function Ot(e){return e.closest(".support-settings")?e.closest(".text-size-control")?e.type!=="radio"||!e.checked?null:e.value==="large"?Et:Tt:e.id.endsWith("-recovery")&&e.type==="checkbox"?e.checked?Lt:Mt:e.id.endsWith("-audio")&&e.type==="checkbox"?e.checked?Ce:Re:null:null}function le(e,t,i){const s=e.closest("label");if(!s)return;const n=[...s.childNodes].find(r=>r.nodeType===Node.TEXT_NODE&&r.textContent?.trim()===t),a=n?.textContent;a&&(n.textContent=a.replace(t,i)),e.setAttribute("aria-label",i)}function qt(e,t,i,s){if(!e.isConnected||!t.isConnected||e.__rf09NotificationGeneration!==s)return;const n=t.ariaNotify;typeof n=="function"&&n.call(t,i,{priority:"normal"})}function Nt(e,t,i){e.__rf09NotificationTimerId!==null&&e.__rf09NotificationTimerId!==void 0&&(window.clearTimeout(e.__rf09NotificationTimerId),e.__rf09NotificationTimerId=null);const s=(e.__rf09NotificationGeneration??0)+1;e.__rf09NotificationGeneration=s,e.__rf09NotificationTimerId=window.setTimeout(()=>{e.__rf09NotificationTimerId=null,qt(e,t,i,s)},Pt)}function Ie(e,t,i){e.__rf09SupportStatusMessage=i,e.requestUpdate(),Nt(e,t,i)}function Vt(e){const t="speechSynthesis"in window?window.speechSynthesis:null;return!!(e.readingAloud||t?.speaking||t?.pending||t?.paused)}function Gt(e,t){t.dataset.rf09AudioInterceptor!=="true"&&(t.dataset.rf09AudioInterceptor="true",t.addEventListener("change",i=>{i.stopImmediatePropagation();const s=t.checked,n=e.audioGuidance;e.recordSupportChange("automatic-audio",n,s),(!s||Vt(e))&&e.stopReading(!1),e.audioGuidance=s,e.invalidatePendingSubmission(),e.persistProgress(),Ie(e,t,s?Ce:Re)},{capture:!0}))}function _t(e){for(const t of e.querySelectorAll("[data-rf09-support-setting-region]")){const i=t.querySelector("[data-rf09-support-feedback]");if(i?.id)for(const s of t.querySelectorAll(".support-settings input"))s.setAttribute("aria-controls",i.id),s.id.endsWith("-audio")&&s.type==="checkbox"&&Gt(e,s)}for(const t of e.querySelectorAll('.text-size-control input[type="radio"][value="standard"]'))le(t,"Standard","Standard text");for(const t of e.querySelectorAll('.text-size-control input[type="radio"][value="large"]'))le(t,"Large","Large text")}function Bt(e,t){const i=t.target;if(!(i instanceof HTMLInputElement)||!e.contains(i)||i.id.endsWith("-audio")&&i.type==="checkbox")return;const s=Ot(i);s&&Ie(e,i,s)}let de=!1;function Ft(){if(de)return;de=!0;const e=d.prototype,t=e.renderSupportSettings;e.renderSupportSettings=function(s,n){const a=this.__rf09SupportStatusMessage??"",r=`rf09-${s}-support-feedback`;return this.updateComplete.then(()=>_t(this)),o`
      <div
    ...
    `}}Ft();const ce=Symbol.for("aqp.rf04.saved-session-recovery.installed");function ue(e,t){return Object.prototype.hasOwnProperty.call(e,t)}function Dt(e,t,i,s){const n=e.findIndex(({id:r})=>!ue(i,r));if(n>=0)return{stage:"ratings",ratingIndex:n};const a=t.findIndex(({id:r})=>!ue(s,r));return a>=0?{stage:"pairs",pairIndex:a}:{stage:"review"}}function Ut(e){const t=e.savedSession;if(!t)return;e.editingRatingFromReview=!1,e.reviewRatingEdit=null,e.reviewReturnFocusIndex=null,e.pairOrder=t.pairOrder,e.pairResponses=t.pairResponses,e.ratings=t.ratings,e.ratingInputRoutes=t.ratingInputRoutes,e.pairInputRoutes=t.pairInputRoutes,e.supportChanges=t.supportChanges,e.startedAt=t.startedAt,e.canAdjustAllSupport?(e.answerMode=t.support.answerMode,e.showSimpleLanguage=t.support.showSimpleLanguage,e.largeText=t.support.largeText,e.audioGuidance=!!t.support.audioGuidance):(e.applyConfiguredSupport(),e.canAdjustPresentationSupport&&(e.largeText=t.support.largeText,e.audioGuidance=!!t.support.audioGuidance));const i=Dt(e.dimensions,e.pairOrder,e.ratings,e.pairResponses);e.stage=i.stage,i.ratingIndex!==void 0&&(e.ratingIndex=i.ratingIndex),i.pairIndex!==void 0&&(e.pairIndex=i.pairIndex),e.recoveryEnabled=!0,e.savedSession=null,e.savedSessionProblem="",e.savedSessionAnnouncementKey="",e.resumeSummaryVisible=!0,e.interruptionSummaryShown=!0,e.statusMessage=`Saved questionnaire resumed at ${e.currentPositionDescription()}.`,e.focusHeading()}function Ht(e){const t=e.target;if(!(t instanceof Element))return;const i=t.closest("#resume-saved-questionnaire");if(!i)return;const s=i.closest("accessible-nasa-tlx, accessible-questionnaire");s?.savedSession&&(e.preventDefault(),e.stopImmediatePropagation(),Ut(s))}function jt(){const e=customElements.get("accessible-nasa-tlx");if(!e)throw new Error("RF-04 recovery policy requires accessible-nasa-tlx to be registered first.");const t=e.prototype;t[ce]||(t.announceSavedSessionOffer=function(s){const n=`${s.configId}:${s.participantCode}:${s.savedAt}`;if(this.savedSessionAnnouncementKey===n)return;this.savedSessionAnnouncementKey=n;const a=this.savedSessionOfferSpeech(s);this.statusMessage="",this.updateComplete.then(()=>{const r=this.savedSession;if(!r||r.savedAt!==s.savedAt||r.configId!==s.configId||r.participantCode!==s.participantCode)return;const l=this.querySelector("#resume-saved-questionnaire");l&&R(l,{block:"center",forceCoordinateScroll:!0,onReveal:()=>this.requestParentReveal(l)}),window.setTimeout(()=>{const h=this.savedSession;!this.isConnected||!h||h.savedAt!==s.savedAt||h.configId!==s.configId||h.participantCode!==s.participantCode||(this.statusMessage=a,this.audioGuidance&&this.speakText(a))},650)})},document.addEventListener("click",Ht,!0),t[ce]=!0)}const Ae="saved-session-dialog",xe="open-saved-session-dialog",ke="resume-saved-questionnaire";function Qt(e,t){const i=e.savedSession;return!!(i&&i.savedAt===t.savedAt&&i.configId===t.configId&&i.participantCode===t.participantCode)}function Wt(e){const t=e.querySelector(`#${ke}`);t&&document.activeElement!==t&&t.focus({preventScroll:!0})}function ze(e){if(!e.savedSession)return;const t=e.querySelector(`#${Ae}`);t&&(t.open||(typeof t.showModal=="function"?t.showModal():(t.setAttribute("open",""),t.setAttribute("aria-modal","true"))),Wt(t))}function Kt(e){e.savedSession&&e.updateComplete.then(()=>{e.querySelector(`#${xe}`)?.focus({preventScroll:!0})})}function Jt(){const e=this.savedSession;if(!e)return null;const t=Object.keys(e.ratings).length+Object.keys(e.pairResponses).length,i=this.dimensions.length+this.pairs.length;return o`
    <section
  ...
  `}function Yt(e){const t=`${e.configId}:${e.participantCode}:${e.savedAt}`;if(this.savedSessionAnnouncementKey===t)return;this.savedSessionAnnouncementKey=t;const i=this.savedSessionOfferSpeech(e);this.statusMessage="",this.updateComplete.then(()=>{!this.isConnected||!Qt(this,e)||(ze(this),this.audioGuidance&&this.speakText(i))})}function Xt(){const e=d.prototype;e.__rf04NativeRecoveryDialogInstalled||(e.__rf04NativeRecoveryDialogInstalled=!0,e.renderSavedSessionOffer=Jt,e.announceSavedSessionOffer=Yt)}const Pe=[{id:"nasa-tlx-weighted",name:"Weighted NASA-TLX",description:"Six workload ratings followed by the standard pairwise weighting task."},{id:"nasa-tlx-raw",name:"Raw NASA-TLX",description:"The six NASA-TLX ratings without pairwise weighting."},{id:"system-usability-scale",name:"System Usability Scale",description:"The standard ten-item SUS agreement questionnaire and scoring rule."}],Zt=new Set(Pe.map(({id:e})=>e));function ei(e){const t=new URLSearchParams(e).get("demo");return t&&Zt.has(t)?t:null}function Ee(e){return new URLSearchParams(e.startsWith("#")?e.slice(1):e).has("study")}function ti(e){const t=Pe.find(({id:s})=>s===e);if(!t)throw new Error("Unsupported demonstration questionnaire.");const i=je({instrumentId:e,studyId:`DEMO-${e}`.slice(0,64),studyTitle:`${t.name} demonstration`,taskLabel:"using the Accessible Questionnaire Platform demonstration",showScoreToParticipant:!0,support:{showSimpleLanguage:!1,answerMode:"standard",largeText:!1,audioGuidance:!1,recoveryEnabled:!1,participantAdjustmentPolicy:"participant-choice",voiceInputAvailable:!0,gazeInputAvailable:e==="nasa-tlx-weighted"},collection:{mode:"local"}},{configId:`public-demo-${e}`,createdAt:"2026-08-22T00:00:00.000Z"});return new URLSearchParams({study:Qe(i),participant:"DEMO"}).toString()}jt();Xt();const Te=document.querySelector("#aqp-root");if(!Te)throw new Error("The AQP root element is missing.");const he=ei(window.location.search);if(he&&!Ee(window.location.hash)){const e=new URL(window.location.href);e.search="",e.hash=ti(he),window.history.replaceState(null,"",e)}Ee(window.location.hash)&&(document.body.classList.remove("aqp-landing-page"),document.title="Participant questionnaire · Accessible Questionnaire Platform Version 0.8",Te.replaceChildren(document.createElement("accessible-questionnaire")));
