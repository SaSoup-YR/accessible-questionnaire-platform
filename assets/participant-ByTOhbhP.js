import{r as ge,s as me,a as h,i as Re,g as Q,D as I,v as w,b as Ie,c as Ae,d as xe,f as R,e as ke,h as ze,j as Pe,k as fe,l as Ee,P as W,A as d,m as o,q as Te,n as K,o as J,p as Le,t as Me,u as Oe,w as Ne,x as be}from"./shared-X-3JE5Gy.js";const qe="accessible-questionnaire:qualtrics-submit:v2",Ve="accessible-questionnaire:qualtrics-receipt:v2",_e="accessible-questionnaire:qualtrics-parent-ready:v2",Ge="accessible-questionnaire:qualtrics-child-ready:v2",Be="accessible-questionnaire:qualtrics-advance-failed:v2",S="0.8.10-q10";function Fe(e=window){const t=e.accessibleQuestionnaireResultSink??e.accessibleNasaTlxResultSink;return!t||typeof t.name!="string"||!t.name.trim()||typeof t.submit!="function"?null:t}function De(e,t=window,i=()=>{},s=()=>{}){if(e.collection.mode!=="qualtrics")return null;const n=Ue(e.collection.parentOrigin,t,i,s),a=He(e.collection.parentOrigin,t,12e3,()=>n.getState()==="connected");return t.accessibleQuestionnaireResultSink=a,t.accessibleNasaTlxResultSink=a,{sink:a,bridge:n}}function Ue(e,t=window,i=()=>{},s=()=>{}){let n="connecting",a=null;const r=(p,m)=>{n==="connected"||n==="failed"&&p!=="connected"||(n=p,i({state:n,message:m}))},l=p=>{if(p.source!==t.parent||p.origin!==e)return;const m=p.data;if(m?.type===Be){m.bridgeBuild===S&&typeof m.error=="string"&&m.error.trim()&&s(m.error);return}if(m?.type===_e){if(m.protocolVersion!==2||m.bridgeBuild!==S){r("failed",`This Qualtrics survey is using an old or incomplete bridge. Expected ${S}. Do not start this questionnaire.`);return}a!==null&&(t.clearTimeout(a),a=null),t.parent.postMessage({type:Ge,protocolVersion:2,bridgeBuild:S},e),r("connected",`Secure Qualtrics bridge ${S} connected.`)}};return t.addEventListener("message",l),i({state:n,message:`Checking Qualtrics bridge ${S}.`}),a=t.setTimeout(()=>{a=null,n!=="connected"&&r("failed",`The required Qualtrics bridge ${S} did not connect. Do not start this questionnaire.`)},8500),{getState:()=>n,disconnect(){a!==null&&(t.clearTimeout(a),a=null),t.removeEventListener("message",l)}}}function He(e,t=window,i=12e3,s=()=>!0){return{name:"UCL Qualtrics",submit(n){return t.parent===t?Promise.reject(new Error("This centrally collected questionnaire must be opened through its Qualtrics survey.")):s()?new Promise((a,r)=>{let l=!1;const p=y=>{l||(l=!0,t.clearTimeout(b),t.removeEventListener("message",m),y())},m=y=>{if(y.source!==t.parent||y.origin!==e)return;const g=y.data;if(!(!g||g.type!==Ve||g.submissionId!==n.submissionId||g.bridgeBuild!==S)){if(g.accepted!==!0){p(()=>r(new Error(typeof g.error=="string"&&g.error?g.error:"Qualtrics did not accept the response.")));return}p(()=>a({accepted:!0,submissionId:n.submissionId,receiptId:typeof g.receiptId=="string"?g.receiptId:void 0}))}},b=t.setTimeout(()=>{p(()=>r(new Error("Qualtrics did not acknowledge the response in time.")))},i);t.addEventListener("message",m),t.parent.postMessage({type:qe,bridgeBuild:S,record:n},e)}):Promise.reject(new Error(`Qualtrics bridge ${S} is not connected. The response remains in the local backup.`))}}}async function je(e,t,i=15e3){let s;const n=new Promise((r,l)=>{s=setTimeout(()=>l(new Error("The study platform did not acknowledge the staged response in time.")),i)});let a;try{a=await Promise.race([t.submit(e),n])}finally{s!==void 0&&clearTimeout(s)}if(!a||a.accepted!==!0||a.submissionId!==e.submissionId||a.receiptId!==void 0&&typeof a.receiptId!="string")throw new Error("The study platform returned an invalid submission receipt.");return a}const D=new Map([["zero",0],["five",5],["one zero",10],["ten",10],["fifteen",15],["twenty",20],["twenty five",25],["thirty",30],["thirty five",35],["forty",40],["forty five",45],["fifty",50],["fifty five",55],["sixty",60],["sixty five",65],["seventy",70],["seventy five",75],["eighty",80],["eighty five",85],["ninety",90],["ninety five",95],["one zero zero",100],["one hundred",100],["hundred",100]]),N=new Map([["zero","0"],["oh","0"],["one","1"],["two","2"],["three","3"],["four","4"],["five","5"],["six","6"],["seven","7"],["eight","8"],["nine","9"]]),z=new Map([["won",1],["to",2],["too",2],["tree",3],["free",3],["for",4],["fore",4],["fife",5],["ate",8]]),Y=["zero","one","two","three","four","five","six","seven","eight","nine","ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen"],Z=["","","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety"];function ye(e){if(e<20)return Y[e];if(e===100)return"one hundred";const t=Math.floor(e/10),i=e%10;return i===0?Z[t]:`${Z[t]} ${Y[i]}`}for(let e=0;e<=100;e+=1){D.set(ye(e),e);const t=String(e).split("").map(i=>[...N].find(([,s])=>s===i)?.[0]).filter(i=>!!i).join(" ");t&&D.set(t,e)}const U=new Set([...N.keys(),"ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","hundred"]),H=/\b(?:not|note|knot|naught|nought|no|nope|nah|never|cannot|cancel|neither|except|without|minus|negative|skip|avoid|exclude|reject|instead|rather|unsure|uncertain|maybe|perhaps|mistake|wrong)\b|\b(?:(?:anything|everything)\s+but|other\s+than|don\s+t|can\s+t|won\s+t|wouldn\s+t|shouldn\s+t|isn\s+t|wasn\s+t)\b/,ve={mental:["mental demand","mental"],physical:["physical demand","physical"],temporal:["temporal demand","temporal","time pressure"],performance:["performance"],effort:["effort"],frustration:["frustration"]};function T(e){return e.toLowerCase().replace(/[-–—]/g," ").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function Qe(e,t,i,s=!0){const n=[];for(const a of t){const r=Number.isInteger(a)&&a>=0&&a<=100?ye(a):String(a);if(n.push(String(a),r,`number ${r}`,`option ${r}`,`rating ${r}`,`value ${r}`,`answer ${r}`,`choice ${r}`),s){const l=e.responseLabels?.[String(a)];l?.trim()&&n.push(l.trim(),`answer ${l.trim()}`,`choose ${l.trim()}`)}}return s&&(n.push(e.lowAnchor,e.highAnchor,...e.voiceLowAliases??[],...e.voiceHighAliases??[]),i.length===5&&n.push("middle","midpoint",`closer to ${e.lowAnchor}`,`closer to ${e.highAnchor}`)),[...new Set(n.map(a=>a.trim()).filter(Boolean))]}function We(e){return[...new Set(e.flatMap(t=>typeof t!="string"?[t.name,t.id.replace(/[-_]/g," ")]:ve[t]??[t.replace(/[-_]/g," ")]).map(t=>t.trim()).filter(Boolean))]}function we(e){return H.test(T(e))}function Se(e,t){const i=e.map(a=>a.trim()).filter(Boolean);if(i.length===0)return null;const s=i.map((a,r)=>({transcript:a,value:t(a),index:r}));if(s.some(({transcript:a,value:r})=>r===null&&we(a)))return null;const n=s.filter(a=>a.value!==null);return n.length===0?null:{transcript:n[0].transcript,value:n[0].value}}function X(e,t){return new Set([e,...t??[]].map(T).filter(Boolean))}function j(e){return e.replace(/^(?:(?:i\s+)?(?:choose|select|pick)|(?:my\s+)?answer(?:\s+is)?|(?:the\s+)?(?:number|option|rating|value|response|choice)(?:\s+is)?)\s+/,"").trim()}function ee(e){return e.replace(/\bdis\s+a\s+gr(?:ay|ey)\b/g,"disagree").replace(/\ba\s+gr(?:ay|ey)\b/g,"agree").replace(/\bstrong\s+lee\b/g,"strongly").replace(/\bdisagreed\b/g,"disagree").replace(/\bagreed\b/g,"agree").replace(/^neither\s+(.+)\s+or\s+(.+)$/,"neither $1 nor $2")}function Ke(e,t,i){const s=j(e),n=X(t.lowAnchor,t.voiceLowAliases).has(s),a=X(t.highAnchor,t.voiceHighAliases).has(s);if(!(!n&&!a))return n&&a?null:n?i[0]:i.at(-1)??null}function Je(e,t,i){if(!t.responseLabels)return;const s=ee(j(e)),n=i.filter(a=>ee(T(t.responseLabels?.[String(a)]??""))===s);if(n.length!==0)return n.length===1?n[0]:null}function Ye(e,t){const i=j(e),s=i.split(" ").filter(Boolean);if(s.length===0||!s.every(r=>/^(?:100|[0-9]{1,2})$/.test(r)||U.has(r)||z.has(r)))return;const a=$e(i,t,!0);return a.length!==1||a[0]===null?null:a[0]}function $e(e,t,i=!1){const s=e.split(" ").filter(Boolean),n=[];for(const a of s)if(/^(?:100|[0-9]{1,2})$/.test(a)){const r=Number(a);n.push(t.includes(r)?r:null)}for(let a=0;a<s.length;){if(!U.has(s[a])&&!(i&&z.has(s[a]))){a+=1;continue}const r=[];for(;a<s.length&&(U.has(s[a])||i&&z.has(s[a]));)r.push(s[a]),a+=1;const l=r.length===1&&N.has(r[0])?Number(N.get(r[0])):r.length===1&&z.has(r[0])?z.get(r[0]):D.get(r.join(" "));n.push(l!==void 0&&t.includes(l)?l:null)}return n}function te(e){return e?.map(t=>t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")).join("|")}function x(e,t){return e.find(i=>i.position===t)?.value}function Ze(e,t,i){const s=/\b(middle|midpoint|centre|center)\b/.test(e),n=te(t.voiceLowAliases),a=te(t.voiceHighAliases);if(!n||!a||i.length!==5)return;const r=`(?:${n})`,l=`(?:${a})`,p=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${r}\\b`).test(e),m=new RegExp(`\\bclose(?:r)?\\s+(?:to|too)\\s+${l}\\b`).test(e),b=t.voiceLowAliases?.includes("low")===!0&&e==="hello",y=new RegExp(`\\b${r}\\b`).test(e)||b,g=new RegExp(`\\b${l}\\b`).test(e);if(p||m)return[s,p,m].filter(Boolean).length!==1||p&&g||m&&y?null:p?x(i,"closer-low")??null:x(i,"closer-high")??null;if([s,y,g].some(Boolean))return[s,y,g].filter(Boolean).length!==1?null:s?x(i,"middle")??null:y?x(i,"low")??null:x(i,"high")??null}function Xe(e,t,i=ge,s=me){const n=T(e);if(!n)return null;const a=Je(n,t,i);if(a!==void 0)return a;const r=Ke(n,t,i);if(r!==void 0)return r;if(H.test(n))return null;const l=Ze(n,t,s),p=Ye(n,i);if(p!==void 0)return p===null||l===null||l!==void 0&&l!==p?null:p;if(l===null)return null;if(l!==void 0){const m=$e(n,i);return m.length===0?l:m.length!==1||m[0]===null||m[0]!==l?null:l}return null}function et(e,t){const i=T(e);if(!i||H.test(i))return null;const s=t.map(n=>{const a=typeof n=="string"?n:n.id;return(typeof n=="string"?ve[a]??[a.replace(/[-_]/g," ")]:[n.name.toLowerCase(),a.replace(/[-_]/g," ")]).some(l=>i===l||i.includes(l))?a:null}).filter(n=>!!n);return s.length===1?s[0]:null}function tt(e,t,i=ge,s=me){return Se(e,n=>Xe(n,t,i,s))}function it(e,t){return Se(e,i=>et(i,t))}const q="3.5.3",st=`https://cdn.jsdelivr.net/npm/webgazer@${q}/dist/webgazer.js`,nt=`https://cdn.jsdelivr.net/npm/webgazer@${q}/dist/mediapipe/face_mesh`,at="sha384-N9TfYQEjUGiaDcITkzB/MtVHEfF2JtTWCwHG8NUhjOSvJ8zObGwfebHUFLBS+4Rb";let k=null;function ie(e){return e.protocol==="https:"||e.hostname==="localhost"||e.hostname==="127.0.0.1"}function rt(e=document){return window.webgazer?Promise.resolve(window.webgazer):k||(k=new Promise((t,i)=>{const s=e.querySelector("#webgazer-loader"),n=s??e.createElement("script"),a=()=>{window.webgazer?t(window.webgazer):i(new Error("WebGazer loaded without exposing its browser API."))};n.addEventListener("load",a,{once:!0}),n.addEventListener("error",()=>{n.remove(),i(new Error("WebGazer could not be downloaded. Check the connection and content-blocking settings."))},{once:!0}),s||(n.id="webgazer-loader",n.src=st,n.integrity=at,n.crossOrigin="anonymous",n.referrerPolicy="no-referrer",e.head.append(n))}).catch(t=>{throw k=null,t}),k)}class se{constructor(t){this.durationMs=t,this.key=null,this.startedAt=0}update(t,i){if(!t)return this.reset(),{progress:0,activated:!1};if(t!==this.key)return this.key=t,this.startedAt=i,{progress:0,activated:!1};const s=Math.min(1,Math.max(0,(i-this.startedAt)/this.durationMs));return s>=1?(this.reset(),{progress:1,activated:!0}):{progress:s,activated:!1}}reset(){this.key=null,this.startedAt=0}}var ot=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,u=(e,t,i,s)=>{for(var n=s>1?void 0:s?lt(t,i):t,a=e.length-1,r;a>=0;a--)(r=e[a])&&(n=(s?r(t,i,n):r(n))||n);return s&&n&&ot(t,i,n),n};function V(e){return e.trim().toLocaleLowerCase().split("-")[0]==="en"}const L=[{x:12,y:12},{x:50,y:12},{x:88,y:12},{x:12,y:50},{x:50,y:50},{x:88,y:50},{x:12,y:88},{x:50,y:88},{x:88,y:88}],A=3;function _(e){const t=fe(e);for(let i=t.length-1;i>0;i-=1){const s=Math.floor(Math.random()*(i+1));[t[i],t[s]]=[t[s],t[i]]}return t}let c=class extends Re{constructor(){super(...arguments),this.stage="intro",this.ratingIndex=0,this.pairIndex=0,this.pairOrder=_(Q(I)),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.answerMode="standard",this.showSimpleLanguage=!1,this.largeText=!1,this.recoveryEnabled=!1,this.resumeSummaryVisible=!1,this.savedSession=null,this.savedSessionProblem="",this.recoveredCompletedRecord=null,this.readingAloud=!1,this.readAloudUsed=!1,this.audioGuidance=!1,this.audioStatusMessage="",this.interruptionSummaryShown=!1,this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.errorMessage="",this.statusMessage="",this.result=null,this.gazeState="off",this.gazeMessage="",this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeUsed=!1,this.gazeActionCount=0,this.studyConfig=null,this.configurationError="",this.participantCode="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.startedAt="",this.submittedRecord=null,this.completionSavedLocally=!1,this.completionStagedByBridge=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.browserStorageFailed=!1,this.submittingResult=!1,this.hostBridgeState="not-required",this.hostBridgeMessage="",this.hiddenAt=null,this.recognition=null,this.webgazer=null,this.gazeCandidateElement=null,this.gazePendingElement=null,this.gazeActivationInProgress=!1,this.speechRequestId=0,this.savedSessionAnnouncementKey="",this.configurationApplied=!1,this.prefilledParticipantCode="",this.invalidParticipantParameter=!1,this.reviewReturnFocusIndex=null,this.installedResultSink=null,this.gazeCandidateTracker=new se(1e3),this.gazeConfirmationTracker=new se(1200),this.repeatSavedSessionOffer=()=>{this.savedSession&&(this.readAloudUsed=!0,this.speakText(this.savedSessionOfferSpeech(this.savedSession)))},this.setParticipantCode=e=>{this.participantCode=e.currentTarget.value.trim(),this.invalidParticipantParameter=!1,this.participantCodeRestoredForTab=!1,this.participantCodeError=this.participantCode&&!w(this.participantCode)?"Use 1–32 letters, numbers, hyphens or underscores, starting with a letter or number.":"",this.savedSession=null,this.savedSessionProblem="",this.recoveredCompletedRecord=null,w(this.participantCode)?(this.rememberParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup()):this.forgetParticipantCodeForTab()},this.setAudioGuidance=e=>{const t=e.currentTarget.checked;this.recordSupportChange("automatic-audio",this.audioGuidance,t),this.audioGuidance=t,this.invalidatePendingSubmission(),this.audioGuidance?this.speakText("Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open."):this.stopReading(),this.persistProgress()},this.startQuestionnaire=()=>{if(this.configurationError){this.showError(this.configurationError);return}if(this.studyConfig?.collection.mode==="qualtrics"&&this.hostBridgeState!=="connected"){this.showError(this.hostBridgeMessage||"The secure Qualtrics result connection is not ready. Do not start this questionnaire.");return}if(this.studyConfig){if(this.participantCode=this.participantCode.trim(),!w(this.participantCode)){this.participantCodeError="Enter the valid pseudonymous participant code supplied by the study conductor.",this.showError(this.participantCodeError);return}this.rememberParticipantCodeForTab()}this.startedAt=new Date().toISOString(),this.stage="ratings",this.ratingIndex=0,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.clearError(),this.persistProgress(),this.focusHeading()},this.goBack=()=>{if(this.stopReading(),this.clearVoiceAnswer(),this.stage==="ratings"&&this.editingRatingFromReview){const e=this.reviewReturnFocusIndex??this.ratingIndex;this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.stage="review",this.clearError(),this.persistProgress(),this.focusReviewItem(e,`${this.dimensions[e].name} edit cancelled. Original answer kept.`);return}else this.stage==="ratings"&&this.ratingIndex>0?this.ratingIndex-=1:this.stage==="pairs"&&(this.pairIndex>0?this.pairIndex-=1:(this.stage="ratings",this.ratingIndex=this.dimensions.length-1));this.clearError(),this.persistProgress(),this.focusHeading()},this.returnToRatings=()=>{this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.stage="ratings",this.ratingIndex=this.dimensions.length-1,this.persistProgress(),this.focusHeading()},this.returnToPairs=()=>{this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.stage="pairs",this.pairIndex=this.pairOrder.length-1,this.persistProgress(),this.focusHeading()},this.submitResponses=async()=>{if(!this.submittingResult)try{(!this.result||!this.submittedRecord)&&(this.result=Ie(this.definition,this.ratings,this.pairResponses),this.submittedRecord=Ae({config:this.effectiveStudyConfig(),participantCode:this.studyConfig?this.participantCode:"DEMO",startedAt:this.startedAt||new Date().toISOString(),pairPresentationOrder:this.pairOrder.map(({id:t})=>t),pairwiseChoices:this.pairResponses,result:this.result,supportMetadata:this.currentSupportMetadata()}));const e=this.studyConfig?Fe():null;if(this.completionSavedLocally=this.studyConfig?xe(this.submittedRecord):!1,this.completionStagedByBridge=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.browserStorageFailed=!1,this.studyConfig&&!this.completionSavedLocally){this.browserStorageFailed=!0,this.showError("The browser could not save the completed record. The study platform has not been contacted. Your answers remain reviewable. Retry saving, change an answer, or download a JSON or CSV backup before leaving this page.");return}if(e){this.submittingResult=!0,this.statusMessage=`Submitting responses to ${e.name}.`;try{await je(this.submittedRecord,e),this.completionStagedByBridge=!0}catch(t){this.hostSubmissionFailed=!0,this.browserStorageFailed=!1;const i=t instanceof Error?t.message:"The study platform did not accept the response.";this.showError(`${i} Your answers remain on this page. Retry submission, return to an answer, or use a backup button below.`);return}finally{this.submittingResult=!1}}this.dispatchEvent(new CustomEvent("questionnaire-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("nasa-tlx-complete",{detail:this.submittedRecord,bubbles:!0,composed:!0})),this.stage="complete",(!this.studyConfig||this.completionSavedLocally)&&this.clearSavedProgress(),this.stopGazeInputInternal(!1),this.clearError(),this.completionStagedByBridge||this.focusHeading()}catch(e){this.submittingResult=!1,this.showError(e instanceof Error?e.message:"Responses could not be calculated.")}},this.downloadResultJson=()=>{this.submittedRecord&&this.downloadRecordJson(this.submittedRecord)},this.downloadResultCsv=()=>{this.submittedRecord&&this.downloadRecordCsv(this.submittedRecord)},this.restart=()=>{this.stopReading(!1),this.stopGazeInputInternal(!1),this.releaseRecognition(),this.clearSavedProgress(),this.forgetParticipantCodeForTab(),this.stage="intro",this.ratingIndex=0,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.pairIndex=0,this.pairOrder=_(this.definition),this.pairResponses={},this.ratings={},this.ratingInputRoutes={},this.pairInputRoutes={},this.supportChanges=[],this.resumeSummaryVisible=!1,this.savedSession=null,this.recoveredCompletedRecord=null,this.result=null,this.submittedRecord=null,this.completionSavedLocally=!1,this.completionStagedByBridge=!1,this.remoteRecordingUnconfirmed=!1,this.hostSubmissionFailed=!1,this.browserStorageFailed=!1,this.submittingResult=!1,this.startedAt="",this.participantCodeError="",this.participantCodeRestoredForTab=!1,this.studyConfig&&(this.participantCode=this.prefilledParticipantCode),this.errorMessage="",this.voiceState="idle",this.pendingVoiceAnswer=null,this.audioGuidance=!1,this.audioStatusMessage="",this.gazeUsed=!1,this.gazeActionCount=0,this.applyConfiguredSupport(),this.statusMessage="A new questionnaire has started.",window.scrollTo({top:0,behavior:"smooth"})},this.toggleReadAloud=()=>{if(this.readingAloud){this.stopReading(!0);return}this.speakText(this.currentStepSpeech())},this.startGazeInput=async()=>{if(!ie(window.location)){this.gazeState="error",this.gazeMessage="Gaze input requires an HTTPS-hosted page or localhost.",this.announceAutomatic(this.gazeMessage);return}this.gazeState="loading",this.gazeMessage="Loading the pinned WebGazer library. Webcam permission will be requested next.";try{const e=await rt();if(!e.detectCompatibility())throw new Error("This browser does not expose a compatible webcam API.");this.webgazer=e,e.params.faceMeshSolutionPath=nt,e.saveDataAcrossSessions(!1),await e.clearData(),e.showVideoPreview(!0),e.showFaceOverlay(!0),e.showFaceFeedbackBox(!0),e.showPredictionPoints(!1),e.setGazeListener(t=>this.handleGazePoint(t)),await e.begin(),e.removeMouseEventListeners(),await this.showGazePositioningStep("Camera started. Position your face, then continue to calibration.")}catch(e){this.gazeState="error",this.gazeMessage=e instanceof Error?`Gaze setup did not start: ${e.message}`:"Gaze setup did not start. Use another answer route.",this.announceAutomatic(this.gazeMessage),this.releaseGazeResources()}},this.restartGazeCalibration=async()=>{this.webgazer&&(this.cancelGazeProposal(),await this.webgazer.clearData(),await this.showGazePositioningStep("Recalibration started. Check your position before continuing."))},this.beginGazeCalibration=()=>{this.webgazer&&(this.restoreWebGazerPreviewContainer(),this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!1),this.gazeCalibrationIndex=0,this.gazeCalibrationRepetition=0,this.gazeState="calibrating",this.gazeMessage="Camera preview hidden. Complete all 27 calibration samples.",this.announceAutomatic(this.gazeMessage),this.updateComplete.then(()=>this.querySelector(".calibration-point")?.focus()))},this.recordCalibrationPoint=e=>{if(!this.webgazer||this.gazeState!=="calibrating")return;const t=e.currentTarget.getBoundingClientRect();if(this.webgazer.recordScreenPosition(t.left+t.width/2,t.top+t.height/2,"click"),this.gazeCalibrationRepetition<A-1){this.gazeCalibrationRepetition+=1;return}if(this.gazeCalibrationIndex<L.length-1){this.gazeCalibrationIndex+=1,this.gazeCalibrationRepetition=0;return}this.gazeCalibrationRepetition=A,this.gazeState="ready",this.gazeUsed=!0,this.gazeMessage="Calibration complete. A red gaze dot is visible. Look at a large answer or navigation control for one second.",this.webgazer.showVideoPreview(!1),this.webgazer.showFaceOverlay(!1),this.webgazer.showFaceFeedbackBox(!1),this.webgazer.showPredictionPoints(!0),this.statusMessage="Gaze-assisted answering is ready.",this.announceAutomatic(this.statusMessage)},this.confirmGazeProposal=()=>{const e=this.gazePendingElement;if(!e)return;const t=this.gazePendingLabel;this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.gazeActivationInProgress=!0;try{e.click(),this.gazeActionCount+=1,this.gazeUsed=!0,this.statusMessage=`${t} activated by confirmed gaze.`}finally{this.gazeActivationInProgress=!1}},this.cancelGazeProposal=()=>{this.gazePendingElement=null,this.gazePendingLabel="",this.gazeDwellProgress=0,this.gazeConfirmationTracker.reset(),this.statusMessage="Gaze proposal cancelled."},this.stopGazeInput=()=>{this.stopGazeInputInternal(!0)},this.confirmVoiceAnswer=()=>{const e=this.pendingVoiceAnswer;if(!e)return;let t="";if(e.context==="rating"){const i=this.dimensions[this.ratingIndex],s=e.value;this.selectRating(i.id,s,"voice"),t=this.answerMode==="smiley"&&this.smileyLandmarks.some(a=>a.value===s)?`smiley-${i.id}-${s}`:`rating-${i.id}-${s}`}else{const i=this.pairOrder[this.pairIndex],s=e.value;this.selectPair(i.id,s,"voice"),t=`${i.id}-${s}`}this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null,this.updateComplete.then(()=>this.querySelector(`#${t}`)?.focus())},this.clearVoiceAnswer=()=>{this.releaseRecognition(),this.voiceState="idle",this.voiceMessage="",this.pendingVoiceAnswer=null},this.handleVisibilityChange=()=>{if(document.hidden){this.hiddenAt=Date.now();return}this.hiddenAt&&this.recoveryEnabled&&this.isInProgress()&&(this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.statusMessage="Welcome back. A summary of your saved position is available.",this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())})),this.hiddenAt=null},this.handleParticipantStudyHashChange=()=>{new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash).has("study")&&this.reloadForParticipantStudyLink()},this.handleSkipToCurrentQuestion=e=>{e.preventDefault(),this.updateComplete.then(()=>{const t=this.querySelector("#question-panel");if(!t)return;const i=t.querySelector("h2")??t;i.hasAttribute("tabindex")||(i.tabIndex=-1),R(i,{block:"start",onReveal:()=>this.requestParentReveal(i)})})},this.dismissResumeSummary=()=>{this.resumeSummaryVisible=!1,this.statusMessage=`Continuing at ${this.currentPositionDescription()}.`,this.focusHeading()},this.restoreSavedSession=()=>{const e=this.savedSession;e&&(this.stage=e.stage,this.editingRatingFromReview=!1,this.reviewRatingEdit=null,this.reviewReturnFocusIndex=null,this.ratingIndex=e.ratingIndex,this.pairIndex=e.pairIndex,this.pairOrder=e.pairOrder,this.pairResponses=e.pairResponses,this.ratings=e.ratings,this.ratingInputRoutes=e.ratingInputRoutes,this.pairInputRoutes=e.pairInputRoutes,this.supportChanges=e.supportChanges,this.startedAt=e.startedAt,this.canAdjustAllSupport?(this.answerMode=e.support.answerMode,this.showSimpleLanguage=e.support.showSimpleLanguage,this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance):(this.applyConfiguredSupport(),this.canAdjustPresentationSupport&&(this.largeText=e.support.largeText,this.audioGuidance=!!e.support.audioGuidance)),this.recoveryEnabled=!0,this.savedSession=null,this.savedSessionProblem="",this.savedSessionAnnouncementKey="",this.resumeSummaryVisible=!0,this.interruptionSummaryShown=!0,this.updateComplete.then(()=>{this.querySelector("#resume-heading")?.focus(),this.announceAutomatic(this.resumeSummarySpeech())}))},this.eraseSavedSession=()=>{this.clearSavedProgress(),this.savedSession=null,this.savedSessionProblem="",this.savedSessionAnnouncementKey="",this.statusMessage="Saved answers erased."}}connectedCallback(){super.connectedCallback(),this.loadStudyConfiguration(),document.addEventListener("visibilitychange",this.handleVisibilityChange),window.addEventListener("hashchange",this.handleParticipantStudyHashChange),queueMicrotask(()=>{this.restoreParticipantCodeForTab(),this.findSavedSession(),this.findCompletedBackup(),this.participantCodeRestoredForTab&&!this.savedSession&&this.recoveredCompletedRecord&&this.updateComplete.then(()=>{const e=this.querySelector("#completed-backup-heading");e&&R(e,{block:"start",onReveal:()=>this.requestParentReveal(e)})})})}disconnectedCallback(){document.removeEventListener("visibilitychange",this.handleVisibilityChange),window.removeEventListener("hashchange",this.handleParticipantStudyHashChange),this.installedResultSink?.bridge.disconnect(),this.installedResultSink=null,this.stopReading(!1),this.releaseRecognition(),this.stopGazeInputInternal(!1),super.disconnectedCallback()}createRenderRoot(){return this}loadStudyConfiguration(){if(this.configurationApplied)return;this.configurationApplied=!0;const e=new URLSearchParams(window.location.hash.startsWith("#")?window.location.hash.slice(1):window.location.hash),t=ke(window.location.hash);if(e.has("study")&&!t){this.configurationError="This participant link contains an invalid or incompatible study configuration. Ask the study conductor for a new link.";return}if(!t)return;this.studyConfig=t;const i=e.get("participant"),s=ze(window.location.hash);if(s?(this.prefilledParticipantCode=s,this.participantCode=s):i&&(this.invalidParticipantParameter=!0,this.participantCodeError="The participant code in this link is invalid. Enter the approved pseudonymous code manually or ask the study conductor for a new link."),this.pairOrder=_(this.definition),this.applyConfiguredSupport(),t.collection.mode==="qualtrics"){if(window.parent===window){this.configurationError="This centrally collected questionnaire must be opened from the approved Qualtrics survey link. Ask the study conductor for that link.";return}if(document.referrer)try{if(new URL(document.referrer).origin!==t.collection.parentOrigin){this.configurationError="This questionnaire was embedded by an unexpected website. Ask the study conductor for the approved Qualtrics survey link.";return}}catch{this.configurationError="The embedding website could not be verified. Ask the study conductor for the approved Qualtrics survey link.";return}this.hostBridgeState="connecting",this.installedResultSink=De(t,window,({state:n,message:a})=>{this.hostBridgeState=n,this.hostBridgeMessage=a},n=>{this.remoteRecordingUnconfirmed=!0,this.statusMessage=n,this.announceAutomatic(this.currentStepSpeech()),this.updateComplete.then(()=>{const a=this.querySelector("#remote-recording-error");a&&R(a,{block:"start",onReveal:()=>this.requestParentReveal(a)})})})}}applyConfiguredSupport(){const e=this.studyConfig?.support;e&&(this.showSimpleLanguage=e.showSimpleLanguage,this.answerMode=e.answerMode,this.largeText=e.largeText,this.audioGuidance=e.audioGuidance,this.recoveryEnabled=e.recoveryEnabled)}get definition(){const e=this.studyConfig?.instrumentId??I;return Pe(e,this.studyConfig?.questionnaireDefinition)}get dimensions(){return this.definition.items}get pairs(){return fe(this.definition)}get ratingValues(){return Ee(this.definition)}get smileyLandmarks(){return this.definition.landmarks??[]}get isResearcherSuppliedDefinition(){return!!this.studyConfig?.questionnaireDefinition}get dimensionById(){return new Map(this.dimensions.map(e=>[e.id,e]))}get canAdjustAllSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get canAdjustPresentationSupport(){return!this.studyConfig||this.studyConfig.support.participantAdjustmentPolicy==="presentation-only"||this.studyConfig.support.participantAdjustmentPolicy==="participant-choice"}get voiceInputAvailable(){return!this.studyConfig||this.studyConfig.support.voiceInputAvailable}get gazeInputAvailable(){return!this.studyConfig||this.studyConfig.support.gazeInputAvailable}render(){return o`
      ...
      <main class=${`app-shell${this.largeText?" large-text":""}`} id="main-content">
        ...
        <header class="app-header">
          <p class="eyebrow">Accessible questionnaire platform · Version ${W}</p>
    ...
    `}renderInQuestionSupport(){return this.studyConfig&&!this.canAdjustAllSupport&&!this.canAdjustPresentationSupport?d:o`
      ${this.studyConfig?this.canAdjustAllSupport?o`<details class="support-toolbar">
            ...
            </details>`:d:o`<details class="support-toolbar">
            <summary>Adjust accessibility support (optional)</summary>
            ${this.renderSupportSettings("toolbar","all")}
          </details>`}
    ...
    `}renderStage(){switch(this.stage){case"intro":return this.renderIntro();case"ratings":return this.renderRating();case"pairs":return this.renderPair();case"review":return this.renderReview();case"complete":return this.renderComplete()}}renderIntro(){const e=this.definition.id===I?"Start the six ratings":`Start the ${this.dimensions.length} items`;return o`
      <section class="panel" id="question-panel" aria-labelledby="intro-heading">
        ...
        ${this.configurationError?o`<div class="error-summary" role="alert"><h3>Study link problem</h3><p>${this.configurationError}</p></div>`:d}
        ...
        <details class="support-toolbar participant-support-setup">
          ...
          ${this.studyConfig?this.canAdjustAllSupport?this.renderSupportSettings("intro","all"):this.canAdjustPresentationSupport?this.renderSupportSettings("intro","presentation-only"):d:this.renderSupportSettings("intro","all")}
    ...
    `:d}renderSupportSettings(e,t){const i=`support-${e}`,s="speechSynthesis"in window&&"SpeechSynthesisUtterance"in window;return o`
      <fieldset class="support-settings">
        ...
        ${t==="all"&&this.definition.supports.smileyLandmarks?o`<fieldset class="answer-mode-control">
            ...
            <label for=${`${i}-standard-answer`}>
              ...
              ${this.answerMode==="standard"?o`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:d}
            </label>
            <label for=${`${i}-smiley-answer`}>
              ...
              ${this.answerMode==="smiley"?o`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:d}
            </label>
          </fieldset>`:d}
    ...
    `}renderReadAloudControl(){const e="speechSynthesis"in window&&"SpeechSynthesisUtterance"in window;return o`
      <div class="quick-support audio-guidance" role="group" aria-label="Built-in audio guidance">
        ...
        ${this.audioStatusMessage?o`<p class="audio-status" role="status" aria-atomic="true">${this.audioStatusMessage}</p>`:d}
    ...
    `}renderGazeSetup(){if(!this.gazeInputAvailable)return d;const e=ie(window.location),t=this.gazeState==="loading"||this.gazeState==="positioning"||this.gazeState==="calibrating"||this.gazeState==="ready";return o`
      <details class="gaze-setup" .open=${this.gazeState!=="off"}>
        ...
        <div class="gaze-setup-content">
          ...
          <ul>
            ...
            <li>WebGazer ${q} is loaded only after you start this feature; its code and face model come from jsDelivr.</li>
          ...
          ${e?d:o`<p class="gaze-warning" role="status">
          ...
          ${this.gazeMessage?o`<p class="gaze-status" role="status">${this.gazeMessage}</p>`:d}
        </div>
      </details>
    ...
    `}renderGazeCalibration(){const e=L[this.gazeCalibrationIndex],t=this.gazeCalibrationIndex*A+this.gazeCalibrationRepetition,i=L.length*A;return o`
      <div class="gaze-calibration" role="dialog" aria-modal="true" aria-labelledby="gaze-calibration-heading">
        ...
        <div class="gaze-calibration-field">
          <button
            ...
            aria-label=${`Calibration point ${this.gazeCalibrationIndex+1} of ${L.length}, sample ${this.gazeCalibrationRepetition+1} of ${A}`}
            @click=${this.recordCalibrationPoint}
          >
            ${this.gazeCalibrationIndex+1}
            <span>${this.gazeCalibrationRepetition+1}/${A}</span>
          </button>
        </div>
      </div>
    ...
    `}renderFullRatingScale(e,t){const i=this.definition.scale.type==="semantic-differential",s=!!e.responseLabels;return o`
      <fieldset class="rating-fieldset">
        ...
        <div class="rating-anchors" aria-hidden="true">
          <span>${i?d:`${this.definition.scale.minimum} — `}<span lang=${this.definition.language} dir="auto">${e.lowAnchor}</span></span>
          <span>${i?d:`${this.definition.scale.maximum} — `}<span lang=${this.definition.language} dir="auto">${e.highAnchor}</span></span>
        </div>
          ...
          ${this.ratingValues.map(n=>{const a=`rating-${e.id}-${n}`,r=this.ratingOptionLabel(e,n),l=this.visibleResponseLabel(e,n);return o`
              ...
              >
                ...
                <span class="rating-option-content">
                  ...
                  ${l?o`<small lang=${this.definition.language} dir="auto">${l}</small>`:d}
                </span>
                ${t===n?o`<span class="selected-marker selected-check" aria-hidden="true">✓</span>`:d}
              </label>
            `})}
        </div>
      </fieldset>
          ...
          ${this.smileyLandmarks.map(({value:i,cue:s})=>{const n=`smiley-${e.id}-${i}`;return o`
              ...
              >
                ...
                <span class="smiley-option-content">
                  ...
                  ${t===i?o`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:d}
                </span>
              </label>
            `})}
        </div>
    ...
    `}renderPairChoice(e,t,i){const s=`${e}-${t.id}`;return o`
      ...
      >
        ...
        <span>
          ...
          ${this.showSimpleLanguage?o`<small>${t.shortMeaning}</small>`:d}
        </span>
        ${i?o`<span class="selected-marker" aria-hidden="true">✓ Selected</span>`:d}
      </label>
    ...
    `:d}renderVoiceInput(e,t,i){if(!this.voiceInputAvailable)return d;const s=!!(window.SpeechRecognition??window.webkitSpeechRecognition),n=this.pendingVoiceAnswer?.context===e,a=e==="rating"?this.ratingVoicePrompt(t):`Say “${t.name}” or “${i.name}”.`;return o`
      <details class="voice-input" .open=${this.voiceState!=="idle"}>
        ...
        <div class="voice-input-content">
          ...
          ${this.voiceMessage?o`<p role="status" aria-live="polite" aria-atomic="true">${this.voiceMessage}</p>`:d}
    ...
    `}renderComplete(){if(!this.result||!this.submittedRecord)return d;const e=!this.studyConfig||this.studyConfig.showScoreToParticipant;return o`
      <section class="panel confirmation" id="question-panel" aria-labelledby="complete-heading">
        ...
        ${this.studyConfig?this.remoteRecordingUnconfirmed?o`<div
              ...
              >
                ...
                ${this.completionSavedLocally?d:o`<p>
        ...
        ${!this.studyConfig||!this.completionStagedByBridge||this.remoteRecordingUnconfirmed?this.renderCompletionReadAloudControl():d}
        ${this.studyConfig?d:o`<details>
        ...
        ${this.studyConfig&&this.completionStagedByBridge?o`<aside class="submission-fallback" aria-labelledby="submission-fallback-heading">
              ...
              ${this.studyConfig?d:o`<button class="secondary-button large-answer-button" type="button" @click=${this.restart}>Start again</button>`}
            </div>`}
        ${this.studyConfig?this.completionStagedByBridge&&!this.remoteRecordingUnconfirmed?d:o`<p>
    ...
    `}announceSavedSessionOffer(e){const t=`${e.configId}:${e.participantCode}:${e.savedAt}`;if(this.savedSessionAnnouncementKey===t)return;this.savedSessionAnnouncementKey=t;const i=this.savedSessionOfferSpeech(e);this.statusMessage="",this.updateComplete.then(()=>{const s=this.savedSession;if(!s||s.savedAt!==e.savedAt||s.configId!==e.configId||s.participantCode!==e.participantCode)return;const n=this.querySelector("#saved-session-offer");n&&R(n,{block:"center",forceCoordinateScroll:!0,onReveal:()=>this.requestParentReveal(n)}),window.setTimeout(()=>{const a=this.savedSession;!this.isConnected||!a||a.savedAt!==e.savedAt||a.configId!==e.configId||a.participantCode!==e.participantCode||(this.statusMessage=i,this.audioGuidance&&this.speakText(i))},650)})}savedSessionOfferSpeech(e){return`Saved questionnaire found. ${Object.keys(e.ratings).length+Object.keys(e.pairResponses).length} of ${this.dimensions.length+this.pairs.length} responses are saved in this browser. Resume saved questionnaire. Erase saved answers.`}renderSavedSessionOffer(){if(!this.savedSession)return d;const e=Object.keys(this.savedSession.ratings).length+Object.keys(this.savedSession.pairResponses).length;return o`
      <aside
    ...
    `:d}renderResumeSummary(){return o`
    ...
    `}setSimpleLanguage(e){const t=e.currentTarget.checked;this.recordSupportChange("simpler-explanations",this.showSimpleLanguage,t),this.showSimpleLanguage=t,this.invalidatePendingSubmission(),this.persistProgress(),this.announceAutomatic(t?this.currentSimpleExplanationSpeech():this.isResearcherSuppliedDefinition?"Simpler explanations are off. The questionnaire item wording remains available.":"Simpler explanations are off. The official questionnaire wording remains available.")}recordSupportChange(e,t,i){!this.studyConfig||t===i||this.stage==="complete"||(this.supportChanges=[...this.supportChanges,{setting:e,from:t,to:i,stage:this.stage,changedAt:new Date().toISOString()}])}setAnswerMode(e){e==="smiley"&&!this.definition.supports.smileyLandmarks||(this.recordSupportChange("answer-mode",this.answerMode,e),this.answerMode=e,this.invalidatePendingSubmission(),this.persistProgress(),this.announceAutomatic(e==="smiley"?"Smiley landmark answer format selected. Each rating offers five labelled values, with the full precise scale available on request.":`Standard answer format selected. Each rating uses ${this.ratingValues.length} values from ${this.definition.scale.minimum} to ${this.definition.scale.maximum} in steps of ${this.definition.scale.step}.`))}setLargeText(e){this.recordSupportChange("text-size",this.largeText?"large":"standard",e?"large":"standard"),this.largeText=e,this.invalidatePendingSubmission(),this.persistProgress(),this.announceAutomatic(`${e?"Large":"Standard"} text selected.`)}setRecovery(e){const t=e.currentTarget.checked;this.recordSupportChange("interruption-recovery",this.recoveryEnabled,t),this.recoveryEnabled=t,this.invalidatePendingSubmission(),this.recoveryEnabled?(this.rememberParticipantCodeForTab(),this.persistProgress()):(this.forgetParticipantCodeForTab(),this.clearSavedProgress()),this.announceAutomatic(t?"Interruption recovery is on. Incomplete answers will be stored in this browser.":"Interruption recovery is off. The saved in-progress copy has been removed.")}landmarkLabel(e,t){const i=this.smileyLandmarks.find(s=>s.value===t)?.position;return i==="low"?e.lowAnchor:i==="closer-low"?`Closer to ${e.lowAnchor}`:i==="middle"?"Middle":i==="closer-high"?`Closer to ${e.highAnchor}`:i==="high"?e.highAnchor:String(t)}ratingValueLabel(e,t){const i=e.responseLabels?.[String(t)];return i&&i!==String(t)?i:t===this.definition.scale.minimum?e.lowAnchor:t===this.definition.scale.maximum?e.highAnchor:null}visibleResponseLabel(e,t){const i=e.responseLabels?.[String(t)];if(!i||i===String(t))return null;const s=t===this.definition.scale.minimum?e.lowAnchor:t===this.definition.scale.maximum?e.highAnchor:null,n=a=>a.replace(/\s+/g," ").trim();return s&&n(i)===n(s)?null:i}ratingOptionLabel(e,t){if(this.definition.scale.type==="semantic-differential"){const s=this.ratingValues.indexOf(t)+1,n=this.ratingValueLabel(e,t);return n?`Position ${s} of ${this.ratingValues.length}, ${n}, for ${e.name}`:`Position ${s} of ${this.ratingValues.length}, between ${e.lowAnchor} and ${e.highAnchor}, for ${e.name}`}const i=this.ratingValueLabel(e,t);return i?`${t}, ${i}, for ${e.name}`:`${t} for ${e.name}`}ratingVoicePrompt(e){if(this.answerMode!=="smiley"){const n=`For the clearest recognition, say “number ${this.ratingValues[Math.min(3,this.ratingValues.length-1)]}”, using any value shown from ${this.definition.scale.minimum} to ${this.definition.scale.maximum} in steps of ${this.definition.scale.step}. Other numbers are not rounded or guessed.`;return this.ratingValues.flatMap(r=>{const l=e.responseLabels?.[String(r)];return l?[`${r}, ${l}`]:[]}).length>0&&V(this.definition.language)?`${n} You may instead say one complete visible answer label.`:this.definition.scale.type==="magnitude"?n:`${n} You may instead say the exact visible endpoint label: ${e.lowAnchor} or ${e.highAnchor}.`}const t=this.smileyLandmarks.map(({value:s})=>this.landmarkLabel(e,s)),i=this.smileyLandmarks.map(({value:s})=>s);return`For the most reliable voice input, say one shown value: ${i.slice(0,-1).join(", ")}, or ${i.at(-1)}. You may instead say one visible label: ${t.slice(0,-1).join(", ")}, or ${t.at(-1)}. On a phone, use the number if a short label such as Low is not recognised.`}ratingVoiceAnswerLabel(e,t){const i=this.answerMode==="smiley"&&this.smileyLandmarks.some(n=>n.value===t),s=this.ratingValueLabel(e,t);return i?`${this.landmarkLabel(e,t)}, value ${t}, for ${e.name}`:s?`${s}, value ${t}, for ${e.name}`:`${t} for ${e.name}`}ratingRouteLabel(e){const t=this.ratingInputRoutes[e];return t==="smiley-landmark"?"smiley landmark":t==="voice"?"voice, confirmed":t==="gaze-standard-scale"?"gaze, standard scale, confirmed":t==="gaze-smiley-landmark"?"gaze, smiley landmark, confirmed":"full scale"}reviewRatingLabel(e){const t=this.ratings[e.id];if(t===void 0)return"No answer";const i=this.ratingValueLabel(e,t);if(this.definition.scale.type==="semantic-differential"){const s=`Position ${this.ratingValues.indexOf(t)+1} of ${this.ratingValues.length}`;return i?`${s} — ${i}`:s}return i?`${t} — ${i}`:String(t)}reviewRatingScaleContextText(e){const t=this.ratings[e.id];return t===void 0||this.ratingValueLabel(e,t)?null:this.definition.scale.type==="semantic-differential"?`Scale endpoints: ${e.lowAnchor} to ${e.highAnchor}`:`Scale: ${this.definition.scale.minimum} — ${e.lowAnchor} to ${this.definition.scale.maximum} — ${e.highAnchor}`}renderReviewRatingScaleContext(e){return this.reviewRatingScaleContextText(e)?this.definition.scale.type==="semantic-differential"?o`<span class="review-scale-context">
      ...
      <details class="voice-input" .open=${this.voiceState!=="idle"}>
        ...
        <div class="voice-input-content">
          ...
          <p class="voice-error" ?hidden=${!b}>
            ${b?this.voiceMessage:""}
          </p>
          ${p&&this.pendingVoiceAnswer?o`
                <div class="voice-confirmation">
                  <p>I heard: <strong lang=${this.definition.language} dir="auto">${this.pendingVoiceAnswer.transcript}</strong></p>
                  <p>Proposed answer: <strong lang=${this.definition.language} dir="auto">${this.pendingVoiceAnswer.label}</strong></p>
                  <p>
    ...
    `},e.releaseRecognition=function(n=this.recognition){le(this),i.call(this,n)},e.startVoiceInput=function(n,a,r,l=!0){E(),le(this),t.call(this,n,a,r,l);const p=this.recognition;if(!p||this.voiceState!=="listening")return;mt(this,p);const m=p.onerror;p.onerror=b=>{if(this.recognition===p){if(this.voiceState==="listening"&&(b.error==="no-speech"||b.error==="aborted")){this.releaseRecognition(p),G(this,oe);return}m?.(b)}},p.onend=()=>{this.recognition===p&&this.voiceState==="listening"&&(this.releaseRecognition(p),G(this,oe))},this.__rf06VoiceWatchdogTimerId=window.setTimeout(()=>{this.__rf06VoiceWatchdogTimerId=null,!(this.recognition!==p||this.voiceState!=="listening")&&(this.releaseRecognition(p),G(this,gt))},ht)}}bt();const yt=typeof globalThis.Element<"u"&&typeof globalThis.Document<"u",B=globalThis.__bypassNativeAriaNotify===!0;if(yt&&(B||!("ariaNotify"in Element.prototype)||!("ariaNotify"in Document.prototype))){let e=function(g){return new Promise(f=>setTimeout(f,g))},t=`${Date.now()}`;try{t=crypto.randomUUID()}catch{}const i=Symbol(),s=`polite-live-region-${t}`,n=`assertive-live-region-${t}`;class a{constructor({element:f,message:v,priority:C="normal"}){this.priority="normal",this.element=f,this.message=v,this.priority=C}#e(){const f=typeof globalThis.CSS<"u"&&typeof globalThis.CSS.supports=="function"&&globalThis.CSS.supports("selector(:modal)"),v=this.element.ownerDocument.querySelector(f?":modal":"dialog[open]");return this.element.isConnected&&!this.element.closest("[inert]")&&(v?.contains(this.element)??!0)}async announce(){if(!this.#e())return;let f=this.element.closest("dialog")||this.element.closest("[role='dialog']")||this.element.getRootNode();(!f||f instanceof Document)&&(f=document.body);const v=this.priority==="high"?n:s;let C=f.querySelector(v);C||(C=document.createElement(v),f.append(C)),await e(250),C.handleMessage(i,this.message)}}const r=new class{#e=[];#t;enqueue(f){if(f.priority==="high"){const v=this.#e.findLastIndex(C=>C.priority==="high");this.#e.splice(v+1,0,f)}else this.#e.push(f);this.#t||this.#i()}async#i(){this.#t=this.#e.shift(),this.#t&&(await this.#t.announce(),this.#t=null,this.#i())}};class l extends HTMLElement{#e=this.attachShadow({mode:"closed"});connectedCallback(){this.ariaAtomic="true",this.style.marginLeft="-1px",this.style.marginTop="-1px",this.style.position="absolute",this.style.width="1px",this.style.height="1px",this.style.overflow="hidden",this.style.clipPath="rect(0 0 0 0)",this.style.overflowWrap="normal"}handleMessage(f=null,v=""){i===f&&(this.#e.textContent===v&&(v+=" "),this.#e.textContent=v)}}class p extends l{connectedCallback(){this.ariaLive="polite",super.connectedCallback()}}class m extends l{connectedCallback(){this.ariaLive="assertive",super.connectedCallback()}}customElements.define(s,p),customElements.define(n,m);const b=function(g,{priority:f="normal"}={}){r.enqueue(new a({element:this,message:g,priority:f}))};(B||!("ariaNotify"in Element.prototype))&&Object.defineProperty(Element.prototype,"ariaNotify",{configurable:!0,writable:!0,value:b});const y=function(g,{priority:f="normal"}={}){r.enqueue(new a({element:this.documentElement,message:g,priority:f}))};(B||!("ariaNotify"in Document.prototype))&&Object.defineProperty(Document.prototype,"ariaNotify",{configurable:!0,writable:!0,value:y})}const vt=400,wt=800,F=50,St="Large text selected.",$t="Standard text selected.",Ct="Interruption recovery is on. Incomplete answers will be stored in this browser.",Rt="Interruption recovery is off. The saved in-progress copy has been removed.",It="Built-in audio guidance is on. New questions, selected answers, voice proposals, simpler help, recovery summaries, errors and completion feedback will be spoken while this page remains open.",At="Built-in audio guidance is off. New questions and feedback will not be spoken automatically.";function xt(e){return e.closest(".support-settings")?e.closest(".text-size-control")?e.type!=="radio"||!e.checked?null:e.value==="large"?St:$t:e.id.endsWith("-recovery")&&e.type==="checkbox"?e.checked?Ct:Rt:e.id.endsWith("-audio")&&e.type==="checkbox"?e.checked?It:At:null:null}function de(e,t,i){const s=e.closest("label");if(!s)return;const n=[...s.childNodes].find(r=>r.nodeType===Node.TEXT_NODE&&r.textContent?.trim()===t),a=n?.textContent;a&&(n.textContent=a.replace(t,i)),e.setAttribute("aria-label",i)}function kt(e){for(const t of e.querySelectorAll("[data-rf09-support-setting-region]")){const i=t.querySelector("[data-rf09-support-feedback]");if(i?.id)for(const s of t.querySelectorAll(".support-settings input"))s.setAttribute("aria-controls",i.id)}for(const t of e.querySelectorAll('.text-size-control input[type="radio"][value="standard"]'))de(t,"Standard","Standard text");for(const t of e.querySelectorAll('.text-size-control input[type="radio"][value="large"]'))de(t,"Large","Large text")}function ce(e,t,i,s){if(!e.isConnected||!t.isConnected||e.__rf09NotificationGeneration!==s)return;const n=t.ariaNotify;typeof n=="function"&&n.call(t,i,{priority:"normal"})}function zt(e,t,i){e.__rf09NotificationTimerId!==null&&e.__rf09NotificationTimerId!==void 0&&(window.clearTimeout(e.__rf09NotificationTimerId),e.__rf09NotificationTimerId=null);const s=(e.__rf09NotificationGeneration??0)+1;if(e.__rf09NotificationGeneration=s,!e.audioGuidance){e.__rf09NotificationTimerId=window.setTimeout(()=>{e.__rf09NotificationTimerId=null,ce(e,t,i,s)},vt);return}let a=0;const r=()=>{if(e.__rf09NotificationTimerId=null,!e.isConnected||!t.isConnected||e.__rf09NotificationGeneration!==s)return;const l="speechSynthesis"in window?window.speechSynthesis:null;if(!l?.speaking){if(a+=F,a<wt){e.__rf09NotificationTimerId=window.setTimeout(r,F);return}l&&(l.pending||l.paused)&&l.cancel(),ce(e,t,i,s)}};e.__rf09NotificationTimerId=window.setTimeout(r,F)}function Pt(e,t,i){e.__rf09SupportStatusMessage=i,e.requestUpdate(),zt(e,t,i)}function Et(e,t){const i=t.target;if(!(i instanceof HTMLInputElement)||!e.contains(i))return;const s=xt(i);s&&Pt(e,i,s)}let ue=!1;function Tt(){if(ue)return;ue=!0;const e=c.prototype,t=e.renderSupportSettings;e.renderSupportSettings=function(s,n){const a=this.__rf09SupportStatusMessage??"",r=`rf09-${s}-support-feedback`;return this.updateComplete.then(()=>kt(this)),o`
      <div
    ...
    `}}Tt();const he=Symbol.for("aqp.rf04.saved-session-recovery.installed");function pe(e,t){return Object.prototype.hasOwnProperty.call(e,t)}function Lt(e,t,i,s){const n=e.findIndex(({id:r})=>!pe(i,r));if(n>=0)return{stage:"ratings",ratingIndex:n};const a=t.findIndex(({id:r})=>!pe(s,r));return a>=0?{stage:"pairs",pairIndex:a}:{stage:"review"}}function Mt(e){const t=e.savedSession;if(!t)return;e.editingRatingFromReview=!1,e.reviewRatingEdit=null,e.reviewReturnFocusIndex=null,e.pairOrder=t.pairOrder,e.pairResponses=t.pairResponses,e.ratings=t.ratings,e.ratingInputRoutes=t.ratingInputRoutes,e.pairInputRoutes=t.pairInputRoutes,e.supportChanges=t.supportChanges,e.startedAt=t.startedAt,e.canAdjustAllSupport?(e.answerMode=t.support.answerMode,e.showSimpleLanguage=t.support.showSimpleLanguage,e.largeText=t.support.largeText,e.audioGuidance=!!t.support.audioGuidance):(e.applyConfiguredSupport(),e.canAdjustPresentationSupport&&(e.largeText=t.support.largeText,e.audioGuidance=!!t.support.audioGuidance));const i=Lt(e.dimensions,e.pairOrder,e.ratings,e.pairResponses);e.stage=i.stage,i.ratingIndex!==void 0&&(e.ratingIndex=i.ratingIndex),i.pairIndex!==void 0&&(e.pairIndex=i.pairIndex),e.recoveryEnabled=!0,e.savedSession=null,e.savedSessionProblem="",e.savedSessionAnnouncementKey="",e.resumeSummaryVisible=!0,e.interruptionSummaryShown=!0,e.statusMessage=`Saved questionnaire resumed at ${e.currentPositionDescription()}.`,e.focusHeading()}function Ot(e){const t=e.target;if(!(t instanceof Element))return;const i=t.closest("#resume-saved-questionnaire");if(!i)return;const s=i.closest("accessible-nasa-tlx, accessible-questionnaire");s?.savedSession&&(e.preventDefault(),e.stopImmediatePropagation(),Mt(s))}function Nt(){const e=customElements.get("accessible-nasa-tlx");if(!e)throw new Error("RF-04 recovery policy requires accessible-nasa-tlx to be registered first.");const t=e.prototype;t[he]||(t.announceSavedSessionOffer=function(s){const n=`${s.configId}:${s.participantCode}:${s.savedAt}`;if(this.savedSessionAnnouncementKey===n)return;this.savedSessionAnnouncementKey=n;const a=this.savedSessionOfferSpeech(s);this.statusMessage="",this.updateComplete.then(()=>{const r=this.savedSession;if(!r||r.savedAt!==s.savedAt||r.configId!==s.configId||r.participantCode!==s.participantCode)return;const l=this.querySelector("#resume-saved-questionnaire");l&&R(l,{block:"center",forceCoordinateScroll:!0,onReveal:()=>this.requestParentReveal(l)}),window.setTimeout(()=>{const p=this.savedSession;!this.isConnected||!p||p.savedAt!==s.savedAt||p.configId!==s.configId||p.participantCode!==s.participantCode||(this.statusMessage=a,this.audioGuidance&&this.speakText(a))},650)})},document.addEventListener("click",Ot,!0),t[he]=!0)}Nt();
