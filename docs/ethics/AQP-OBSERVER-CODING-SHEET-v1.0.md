...
| --- | --- | --- | --- | --- | --- |
| | | content/order; labels/values; required; scoring/name; code/data; collection/link; navigation; false completion | Yes / No | exact observer words or None | |
| | | | | | |
| | | | | | |
| | | | | | |
...
| --- | --- | --- |
| Correct title and task | | |
| Correct pseudonymous code route | | |
| 10 supplied items in order | | |
| Values 1–5 and supplied endpoint labels | | |
| Every item required | | |
| One question per screen | | |
| Brooke score named `SUS score` | | |
