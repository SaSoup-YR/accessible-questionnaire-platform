...
Please read each statement. Enter your initials only if you agree. An empty row
means that you do not consent to that part. Ask any question before signing.
...
| 8 | I understand what data are collected, how they will be used and that raw recordings will be securely deleted no later than 30 November 2026. | |
| 9 | I understand that I can request removal of my identifiable and coded data within seven calendar days after my session by giving my study code. | |
| 10 | I agree that de-identified results and short anonymous quotations may be used in a dissertation, research paper, presentation or teaching material. | |
| 11 | I voluntarily agree to take part in this study. | |

**Participant name or approved identifier:**


**Signature or typed electronic signature:**


**Date:**


**Study code (researcher completes):**
