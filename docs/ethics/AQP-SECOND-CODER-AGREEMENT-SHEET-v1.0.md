...
## Coder and frozen selection

| Field | Record |
| --- | --- |
| Second coder name and UCL role | |
| Access/confidentiality approval | |
| Selection frozen on/by whom | |
| AQ recording evidence ID | |
| QA recording evidence ID | |
| Coding completed before primary codes opened | Yes / No |

## Independent coding — repeat for each selected session

| Field | AQP condition | Qualtrics condition |
| --- | --- | --- |
